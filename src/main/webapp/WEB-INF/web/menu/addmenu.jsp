    ...
    <form id="addmenu" method="post">
        ...
        <div style="padding-top: 10px">
            <tr>
                ...
                <input class="easyui-validatebox" type="text" id="id" name="id" data-options="required:true,validType:['Number','idisOnly']"  />
            </tr>
        </div>
        <div style="padding-top: 10px">
            <tr>
                <td width="60" align="right" >资源路径</td>
                <input class="easyui-validatebox" type="text" id="url" name="url" data-options="required:true" />
            </tr>
        </div>
        <div style="padding-top: 10px">
            <tr>

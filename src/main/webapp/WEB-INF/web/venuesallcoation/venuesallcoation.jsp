...
<div region="center" fit="true" title="场馆配置管理">

    <table id="venuesallocation" toolbar="#tb" ></table>
    <div id="tb">
        <table>
...
<script>
    $('#venuesallocation').datagrid({
        url : 'venuesallocationinfo.action',

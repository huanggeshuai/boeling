...
<div class="easyui-layout" data-options="fit:true"  style="width:400px; height:300px;padding:10px;">
    <form id="addvenuesallocation" method="post">
        <div style="padding-top: 10px">
            <tr>
                <td width="60" align="right" >场馆负责人</td>
                <input class="easyui-validatebox" type="text" id="venuesid" name="venuesid"
                       data-options="required:true"
                       style="width: 120px "  value='${venuesA.userCharge.userTruename}' disabled="disabled" />
            </tr>
        </div>
        <div style="padding-top: 10px">
            <tr>
...
<script type="text/javascript">
    ...
    $('#addvenuesallocation').form({
        url:"addvenuesallocation.action?venuesid="+${venuesA.venuesid},
        onSubmit: function(){
            if(!$("#addvenuesallocation").form("validate")){
                $.messager.show({
                    title:'提示信息' ,
                    msg:'内容不能为空!'
                });

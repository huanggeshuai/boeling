...
<div>
    <form enctype="multipart/form-data" id="pfm" method="POST">
        <fieldset>
            <legend class="optional">场馆图片:</legend>
            <div class="form-row">
                <div>
                    <input  type="hidden"  />
                    选择图片:<input id="file" style="width:224px" runat="server" name="file" onchange="javascript:setImagePreview(this,localImag,preview);" type="file" />
                </div>
                预　　览:
                <div id="localImag">
                    <%--<img src="/upload/20140566152/20140566152PersonalPicture.jpg">--%>
                    <%--预览，默认图片--%>
                    <img id="preview" alt="预览图片" onclick="over(preview,divImage,imgbig);" src='${venuesupload.imageurl}' style="width: 200px; height: 200px;"/>
                </div>
            </div>
        </fieldset>

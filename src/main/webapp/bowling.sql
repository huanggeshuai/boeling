...
CREATE TABLE `areas`  (
  ...
  CONSTRAINT `areas_ibfk_1` FOREIGN KEY (`cityid`) REFERENCES `cities` (`cityid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `authority`  (
  ...
  `authority_nane` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '权限',
  `describe` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '权限描述',
...
-- ----------------------------
INSERT INTO `authority` VALUES (1, '管理员', '拥有全部菜单');
INSERT INTO `authority` VALUES (2, '馆长', '每个馆的馆长');
INSERT INTO `authority` VALUES (3, '用户', '普通用户');
...
CREATE TABLE `cities`  (
  ...
  CONSTRAINT `cities_ibfk_1` FOREIGN KEY (`provinceid`) REFERENCES `provinces` (`provinceid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1036 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cities
-- ----------------------------
INSERT INTO `cities` VALUES (691, 110100, '市辖区', 110000);
INSERT INTO `cities` VALUES (692, 110200, '县', 110000);
INSERT INTO `cities` VALUES (693, 120100, '市辖区', 120000);
INSERT INTO `cities` VALUES (694, 120200, '县', 120000);
INSERT INTO `cities` VALUES (695, 130100, '石家庄市', 130000);
INSERT INTO `cities` VALUES (696, 130200, '唐山市', 130000);
INSERT INTO `cities` VALUES (697, 130300, '秦皇岛市', 130000);
INSERT INTO `cities` VALUES (698, 130400, '邯郸市', 130000);
INSERT INTO `cities` VALUES (699, 130500, '邢台市', 130000);
INSERT INTO `cities` VALUES (700, 130600, '保定市', 130000);
INSERT INTO `cities` VALUES (701, 130700, '张家口市', 130000);
INSERT INTO `cities` VALUES (702, 130800, '承德市', 130000);
INSERT INTO `cities` VALUES (703, 130900, '沧州市', 130000);
INSERT INTO `cities` VALUES (704, 131000, '廊坊市', 130000);
INSERT INTO `cities` VALUES (705, 131100, '衡水市', 130000);
INSERT INTO `cities` VALUES (706, 140100, '太原市', 140000);
INSERT INTO `cities` VALUES (707, 140200, '大同市', 140000);
INSERT INTO `cities` VALUES (708, 140300, '阳泉市', 140000);
INSERT INTO `cities` VALUES (709, 140400, '长治市', 140000);
INSERT INTO `cities` VALUES (710, 140500, '晋城市', 140000);
INSERT INTO `cities` VALUES (711, 140600, '朔州市', 140000);
INSERT INTO `cities` VALUES (712, 140700, '晋中市', 140000);
INSERT INTO `cities` VALUES (713, 140800, '运城市', 140000);
INSERT INTO `cities` VALUES (714, 140900, '忻州市', 140000);
INSERT INTO `cities` VALUES (715, 141000, '临汾市', 140000);
INSERT INTO `cities` VALUES (716, 141100, '吕梁市', 140000);
INSERT INTO `cities` VALUES (717, 150100, '呼和浩特市', 150000);
INSERT INTO `cities` VALUES (718, 150200, '包头市', 150000);
INSERT INTO `cities` VALUES (719, 150300, '乌海市', 150000);
INSERT INTO `cities` VALUES (720, 150400, '赤峰市', 150000);
INSERT INTO `cities` VALUES (721, 150500, '通辽市', 150000);
INSERT INTO `cities` VALUES (722, 150600, '鄂尔多斯市', 150000);
INSERT INTO `cities` VALUES (723, 150700, '呼伦贝尔市', 150000);
INSERT INTO `cities` VALUES (724, 150800, '巴彦淖尔市', 150000);
INSERT INTO `cities` VALUES (725, 150900, '乌兰察布市', 150000);
INSERT INTO `cities` VALUES (726, 152200, '兴安盟', 150000);
INSERT INTO `cities` VALUES (727, 152500, '锡林郭勒盟', 150000);
INSERT INTO `cities` VALUES (728, 152900, '阿拉善盟', 150000);
INSERT INTO `cities` VALUES (729, 210100, '沈阳市', 210000);
INSERT INTO `cities` VALUES (730, 210200, '大连市', 210000);
INSERT INTO `cities` VALUES (731, 210300, '鞍山市', 210000);
INSERT INTO `cities` VALUES (732, 210400, '抚顺市', 210000);
INSERT INTO `cities` VALUES (733, 210500, '本溪市', 210000);
INSERT INTO `cities` VALUES (734, 210600, '丹东市', 210000);
INSERT INTO `cities` VALUES (735, 210700, '锦州市', 210000);
INSERT INTO `cities` VALUES (736, 210800, '营口市', 210000);
INSERT INTO `cities` VALUES (737, 210900, '阜新市', 210000);
INSERT INTO `cities` VALUES (738, 211000, '辽阳市', 210000);
INSERT INTO `cities` VALUES (739, 211100, '盘锦市', 210000);
INSERT INTO `cities` VALUES (740, 211200, '铁岭市', 210000);
INSERT INTO `cities` VALUES (741, 211300, '朝阳市', 210000);
INSERT INTO `cities` VALUES (742, 211400, '葫芦岛市', 210000);
INSERT INTO `cities` VALUES (743, 220100, '长春市', 220000);
INSERT INTO `cities` VALUES (744, 220200, '吉林市', 220000);
INSERT INTO `cities` VALUES (745, 220300, '四平市', 220000);
INSERT INTO `cities` VALUES (746, 220400, '辽源市', 220000);
INSERT INTO `cities` VALUES (747, 220500, '通化市', 220000);
INSERT INTO `cities` VALUES (748, 220600, '白山市', 220000);
INSERT INTO `cities` VALUES (749, 220700, '松原市', 220000);
INSERT INTO `cities` VALUES (750, 220800, '白城市', 220000);
INSERT INTO `cities` VALUES (751, 222400, '延边朝鲜族自治州', 220000);
INSERT INTO `cities` VALUES (752, 230100, '哈尔滨市', 230000);
INSERT INTO `cities` VALUES (753, 230200, '齐齐哈尔市', 230000);
INSERT INTO `cities` VALUES (754, 230300, '鸡西市', 230000);
INSERT INTO `cities` VALUES (755, 230400, '鹤岗市', 230000);
INSERT INTO `cities` VALUES (756, 230500, '双鸭山市', 230000);
INSERT INTO `cities` VALUES (757, 230600, '大庆市', 230000);
INSERT INTO `cities` VALUES (758, 230700, '伊春市', 230000);
INSERT INTO `cities` VALUES (759, 230800, '佳木斯市', 230000);
INSERT INTO `cities` VALUES (760, 230900, '七台河市', 230000);
INSERT INTO `cities` VALUES (761, 231000, '牡丹江市', 230000);
INSERT INTO `cities` VALUES (762, 231100, '黑河市', 230000);
INSERT INTO `cities` VALUES (763, 231200, '绥化市', 230000);
INSERT INTO `cities` VALUES (764, 232700, '大兴安岭地区', 230000);
INSERT INTO `cities` VALUES (765, 310100, '市辖区', 310000);
INSERT INTO `cities` VALUES (766, 310200, '县', 310000);
INSERT INTO `cities` VALUES (767, 320100, '南京市', 320000);
INSERT INTO `cities` VALUES (768, 320200, '无锡市', 320000);
INSERT INTO `cities` VALUES (769, 320300, '徐州市', 320000);
INSERT INTO `cities` VALUES (770, 320400, '常州市', 320000);
INSERT INTO `cities` VALUES (771, 320500, '苏州市', 320000);
INSERT INTO `cities` VALUES (772, 320600, '南通市', 320000);
INSERT INTO `cities` VALUES (773, 320700, '连云港市', 320000);
INSERT INTO `cities` VALUES (774, 320800, '淮安市', 320000);
INSERT INTO `cities` VALUES (775, 320900, '盐城市', 320000);
INSERT INTO `cities` VALUES (776, 321000, '扬州市', 320000);
INSERT INTO `cities` VALUES (777, 321100, '镇江市', 320000);
INSERT INTO `cities` VALUES (778, 321200, '泰州市', 320000);
INSERT INTO `cities` VALUES (779, 321300, '宿迁市', 320000);
INSERT INTO `cities` VALUES (780, 330100, '杭州市', 330000);
INSERT INTO `cities` VALUES (781, 330200, '宁波市', 330000);
INSERT INTO `cities` VALUES (782, 330300, '温州市', 330000);
INSERT INTO `cities` VALUES (783, 330400, '嘉兴市', 330000);
INSERT INTO `cities` VALUES (784, 330500, '湖州市', 330000);
INSERT INTO `cities` VALUES (785, 330600, '绍兴市', 330000);
INSERT INTO `cities` VALUES (786, 330700, '金华市', 330000);
INSERT INTO `cities` VALUES (787, 330800, '衢州市', 330000);
INSERT INTO `cities` VALUES (788, 330900, '舟山市', 330000);
INSERT INTO `cities` VALUES (789, 331000, '台州市', 330000);
INSERT INTO `cities` VALUES (790, 331100, '丽水市', 330000);
INSERT INTO `cities` VALUES (791, 340100, '合肥市', 340000);
INSERT INTO `cities` VALUES (792, 340200, '芜湖市', 340000);
INSERT INTO `cities` VALUES (793, 340300, '蚌埠市', 340000);
INSERT INTO `cities` VALUES (794, 340400, '淮南市', 340000);
INSERT INTO `cities` VALUES (795, 340500, '马鞍山市', 340000);
INSERT INTO `cities` VALUES (796, 340600, '淮北市', 340000);
INSERT INTO `cities` VALUES (797, 340700, '铜陵市', 340000);
INSERT INTO `cities` VALUES (798, 340800, '安庆市', 340000);
INSERT INTO `cities` VALUES (799, 341000, '黄山市', 340000);
INSERT INTO `cities` VALUES (800, 341100, '滁州市', 340000);
INSERT INTO `cities` VALUES (801, 341200, '阜阳市', 340000);
INSERT INTO `cities` VALUES (802, 341300, '宿州市', 340000);
INSERT INTO `cities` VALUES (803, 341400, '巢湖市', 340000);
INSERT INTO `cities` VALUES (804, 341500, '六安市', 340000);
INSERT INTO `cities` VALUES (805, 341600, '亳州市', 340000);
INSERT INTO `cities` VALUES (806, 341700, '池州市', 340000);
INSERT INTO `cities` VALUES (807, 341800, '宣城市', 340000);
INSERT INTO `cities` VALUES (808, 350100, '福州市', 350000);
INSERT INTO `cities` VALUES (809, 350200, '厦门市', 350000);
INSERT INTO `cities` VALUES (810, 350300, '莆田市', 350000);
INSERT INTO `cities` VALUES (811, 350400, '三明市', 350000);
INSERT INTO `cities` VALUES (812, 350500, '泉州市', 350000);
INSERT INTO `cities` VALUES (813, 350600, '漳州市', 350000);
INSERT INTO `cities` VALUES (814, 350700, '南平市', 350000);
INSERT INTO `cities` VALUES (815, 350800, '龙岩市', 350000);
INSERT INTO `cities` VALUES (816, 350900, '宁德市', 350000);
INSERT INTO `cities` VALUES (817, 360100, '南昌市', 360000);
INSERT INTO `cities` VALUES (818, 360200, '景德镇市', 360000);
INSERT INTO `cities` VALUES (819, 360300, '萍乡市', 360000);
INSERT INTO `cities` VALUES (820, 360400, '九江市', 360000);
INSERT INTO `cities` VALUES (821, 360500, '新余市', 360000);
INSERT INTO `cities` VALUES (822, 360600, '鹰潭市', 360000);
INSERT INTO `cities` VALUES (823, 360700, '赣州市', 360000);
INSERT INTO `cities` VALUES (824, 360800, '吉安市', 360000);
INSERT INTO `cities` VALUES (825, 360900, '宜春市', 360000);
INSERT INTO `cities` VALUES (826, 361000, '抚州市', 360000);
INSERT INTO `cities` VALUES (827, 361100, '上饶市', 360000);
INSERT INTO `cities` VALUES (828, 370100, '济南市', 370000);
INSERT INTO `cities` VALUES (829, 370200, '青岛市', 370000);
INSERT INTO `cities` VALUES (830, 370300, '淄博市', 370000);
INSERT INTO `cities` VALUES (831, 370400, '枣庄市', 370000);
INSERT INTO `cities` VALUES (832, 370500, '东营市', 370000);
INSERT INTO `cities` VALUES (833, 370600, '烟台市', 370000);
INSERT INTO `cities` VALUES (834, 370700, '潍坊市', 370000);
INSERT INTO `cities` VALUES (835, 370800, '济宁市', 370000);
INSERT INTO `cities` VALUES (836, 370900, '泰安市', 370000);
INSERT INTO `cities` VALUES (837, 371000, '威海市', 370000);
INSERT INTO `cities` VALUES (838, 371100, '日照市', 370000);
INSERT INTO `cities` VALUES (839, 371200, '莱芜市', 370000);
INSERT INTO `cities` VALUES (840, 371300, '临沂市', 370000);
INSERT INTO `cities` VALUES (841, 371400, '德州市', 370000);
INSERT INTO `cities` VALUES (842, 371500, '聊城市', 370000);
INSERT INTO `cities` VALUES (843, 371600, '滨州市', 370000);
INSERT INTO `cities` VALUES (844, 371700, '荷泽市', 370000);
INSERT INTO `cities` VALUES (845, 410100, '郑州市', 410000);
INSERT INTO `cities` VALUES (846, 410200, '开封市', 410000);
INSERT INTO `cities` VALUES (847, 410300, '洛阳市', 410000);
INSERT INTO `cities` VALUES (848, 410400, '平顶山市', 410000);
INSERT INTO `cities` VALUES (849, 410500, '安阳市', 410000);
INSERT INTO `cities` VALUES (850, 410600, '鹤壁市', 410000);
INSERT INTO `cities` VALUES (851, 410700, '新乡市', 410000);
INSERT INTO `cities` VALUES (852, 410800, '焦作市', 410000);
INSERT INTO `cities` VALUES (853, 410900, '濮阳市', 410000);
INSERT INTO `cities` VALUES (854, 411000, '许昌市', 410000);
INSERT INTO `cities` VALUES (855, 411100, '漯河市', 410000);
INSERT INTO `cities` VALUES (856, 411200, '三门峡市', 410000);
INSERT INTO `cities` VALUES (857, 411300, '南阳市', 410000);
INSERT INTO `cities` VALUES (858, 411400, '商丘市', 410000);
INSERT INTO `cities` VALUES (859, 411500, '信阳市', 410000);
INSERT INTO `cities` VALUES (860, 411600, '周口市', 410000);
INSERT INTO `cities` VALUES (861, 411700, '驻马店市', 410000);
INSERT INTO `cities` VALUES (862, 420100, '武汉市', 420000);
INSERT INTO `cities` VALUES (863, 420200, '黄石市', 420000);
INSERT INTO `cities` VALUES (864, 420300, '十堰市', 420000);
INSERT INTO `cities` VALUES (865, 420500, '宜昌市', 420000);
INSERT INTO `cities` VALUES (866, 420600, '襄樊市', 420000);
INSERT INTO `cities` VALUES (867, 420700, '鄂州市', 420000);
INSERT INTO `cities` VALUES (868, 420800, '荆门市', 420000);
INSERT INTO `cities` VALUES (869, 420900, '孝感市', 420000);
INSERT INTO `cities` VALUES (870, 421000, '荆州市', 420000);
INSERT INTO `cities` VALUES (871, 421100, '黄冈市', 420000);
INSERT INTO `cities` VALUES (872, 421200, '咸宁市', 420000);
INSERT INTO `cities` VALUES (873, 421300, '随州市', 420000);
INSERT INTO `cities` VALUES (874, 422800, '恩施土家族苗族自治州', 420000);
INSERT INTO `cities` VALUES (875, 429000, '省直辖行政单位', 420000);
INSERT INTO `cities` VALUES (876, 430100, '长沙市', 430000);
INSERT INTO `cities` VALUES (877, 430200, '株洲市', 430000);
INSERT INTO `cities` VALUES (878, 430300, '湘潭市', 430000);
INSERT INTO `cities` VALUES (879, 430400, '衡阳市', 430000);
INSERT INTO `cities` VALUES (880, 430500, '邵阳市', 430000);
INSERT INTO `cities` VALUES (881, 430600, '岳阳市', 430000);
INSERT INTO `cities` VALUES (882, 430700, '常德市', 430000);
INSERT INTO `cities` VALUES (883, 430800, '张家界市', 430000);
INSERT INTO `cities` VALUES (884, 430900, '益阳市', 430000);
INSERT INTO `cities` VALUES (885, 431000, '郴州市', 430000);
INSERT INTO `cities` VALUES (886, 431100, '永州市', 430000);
INSERT INTO `cities` VALUES (887, 431200, '怀化市', 430000);
INSERT INTO `cities` VALUES (888, 431300, '娄底市', 430000);
INSERT INTO `cities` VALUES (889, 433100, '湘西土家族苗族自治州', 430000);
INSERT INTO `cities` VALUES (890, 440100, '广州市', 440000);
INSERT INTO `cities` VALUES (891, 440200, '韶关市', 440000);
INSERT INTO `cities` VALUES (892, 440300, '深圳市', 440000);
INSERT INTO `cities` VALUES (893, 440400, '珠海市', 440000);
INSERT INTO `cities` VALUES (894, 440500, '汕头市', 440000);
INSERT INTO `cities` VALUES (895, 440600, '佛山市', 440000);
INSERT INTO `cities` VALUES (896, 440700, '江门市', 440000);
INSERT INTO `cities` VALUES (897, 440800, '湛江市', 440000);
INSERT INTO `cities` VALUES (898, 440900, '茂名市', 440000);
INSERT INTO `cities` VALUES (899, 441200, '肇庆市', 440000);
INSERT INTO `cities` VALUES (900, 441300, '惠州市', 440000);
INSERT INTO `cities` VALUES (901, 441400, '梅州市', 440000);
INSERT INTO `cities` VALUES (902, 441500, '汕尾市', 440000);
INSERT INTO `cities` VALUES (903, 441600, '河源市', 440000);
INSERT INTO `cities` VALUES (904, 441700, '阳江市', 440000);
INSERT INTO `cities` VALUES (905, 441800, '清远市', 440000);
INSERT INTO `cities` VALUES (906, 441900, '东莞市', 440000);
INSERT INTO `cities` VALUES (907, 442000, '中山市', 440000);
INSERT INTO `cities` VALUES (908, 445100, '潮州市', 440000);
INSERT INTO `cities` VALUES (909, 445200, '揭阳市', 440000);
INSERT INTO `cities` VALUES (910, 445300, '云浮市', 440000);
INSERT INTO `cities` VALUES (911, 450100, '南宁市', 450000);
INSERT INTO `cities` VALUES (912, 450200, '柳州市', 450000);
INSERT INTO `cities` VALUES (913, 450300, '桂林市', 450000);
INSERT INTO `cities` VALUES (914, 450400, '梧州市', 450000);
INSERT INTO `cities` VALUES (915, 450500, '北海市', 450000);
INSERT INTO `cities` VALUES (916, 450600, '防城港市', 450000);
INSERT INTO `cities` VALUES (917, 450700, '钦州市', 450000);
INSERT INTO `cities` VALUES (918, 450800, '贵港市', 450000);
INSERT INTO `cities` VALUES (919, 450900, '玉林市', 450000);
INSERT INTO `cities` VALUES (920, 451000, '百色市', 450000);
INSERT INTO `cities` VALUES (921, 451100, '贺州市', 450000);
INSERT INTO `cities` VALUES (922, 451200, '河池市', 450000);
INSERT INTO `cities` VALUES (923, 451300, '来宾市', 450000);
INSERT INTO `cities` VALUES (924, 451400, '崇左市', 450000);
INSERT INTO `cities` VALUES (925, 460100, '海口市', 460000);
INSERT INTO `cities` VALUES (926, 460200, '三亚市', 460000);
INSERT INTO `cities` VALUES (927, 469000, '省直辖县级行政单位', 460000);
INSERT INTO `cities` VALUES (928, 500100, '市辖区', 500000);
INSERT INTO `cities` VALUES (929, 500200, '县', 500000);
INSERT INTO `cities` VALUES (930, 500300, '市', 500000);
INSERT INTO `cities` VALUES (931, 510100, '成都市', 510000);
INSERT INTO `cities` VALUES (932, 510300, '自贡市', 510000);
INSERT INTO `cities` VALUES (933, 510400, '攀枝花市', 510000);
INSERT INTO `cities` VALUES (934, 510500, '泸州市', 510000);
INSERT INTO `cities` VALUES (935, 510600, '德阳市', 510000);
INSERT INTO `cities` VALUES (936, 510700, '绵阳市', 510000);
INSERT INTO `cities` VALUES (937, 510800, '广元市', 510000);
INSERT INTO `cities` VALUES (938, 510900, '遂宁市', 510000);
INSERT INTO `cities` VALUES (939, 511000, '内江市', 510000);
INSERT INTO `cities` VALUES (940, 511100, '乐山市', 510000);
INSERT INTO `cities` VALUES (941, 511300, '南充市', 510000);
INSERT INTO `cities` VALUES (942, 511400, '眉山市', 510000);
INSERT INTO `cities` VALUES (943, 511500, '宜宾市', 510000);
INSERT INTO `cities` VALUES (944, 511600, '广安市', 510000);
INSERT INTO `cities` VALUES (945, 511700, '达州市', 510000);
INSERT INTO `cities` VALUES (946, 511800, '雅安市', 510000);
INSERT INTO `cities` VALUES (947, 511900, '巴中市', 510000);
INSERT INTO `cities` VALUES (948, 512000, '资阳市', 510000);
INSERT INTO `cities` VALUES (949, 513200, '阿坝藏族羌族自治州', 510000);
INSERT INTO `cities` VALUES (950, 513300, '甘孜藏族自治州', 510000);
INSERT INTO `cities` VALUES (951, 513400, '凉山彝族自治州', 510000);
INSERT INTO `cities` VALUES (952, 520100, '贵阳市', 520000);
INSERT INTO `cities` VALUES (953, 520200, '六盘水市', 520000);
INSERT INTO `cities` VALUES (954, 520300, '遵义市', 520000);
INSERT INTO `cities` VALUES (955, 520400, '安顺市', 520000);
INSERT INTO `cities` VALUES (956, 522200, '铜仁地区', 520000);
INSERT INTO `cities` VALUES (957, 522300, '黔西南布依族苗族自治州', 520000);
INSERT INTO `cities` VALUES (958, 522400, '毕节地区', 520000);
INSERT INTO `cities` VALUES (959, 522600, '黔东南苗族侗族自治州', 520000);
INSERT INTO `cities` VALUES (960, 522700, '黔南布依族苗族自治州', 520000);
INSERT INTO `cities` VALUES (961, 530100, '昆明市', 530000);
INSERT INTO `cities` VALUES (962, 530300, '曲靖市', 530000);
INSERT INTO `cities` VALUES (963, 530400, '玉溪市', 530000);
INSERT INTO `cities` VALUES (964, 530500, '保山市', 530000);
INSERT INTO `cities` VALUES (965, 530600, '昭通市', 530000);
INSERT INTO `cities` VALUES (966, 530700, '丽江市', 530000);
INSERT INTO `cities` VALUES (967, 530800, '思茅市', 530000);
INSERT INTO `cities` VALUES (968, 530900, '临沧市', 530000);
INSERT INTO `cities` VALUES (969, 532300, '楚雄彝族自治州', 530000);
INSERT INTO `cities` VALUES (970, 532500, '红河哈尼族彝族自治州', 530000);
INSERT INTO `cities` VALUES (971, 532600, '文山壮族苗族自治州', 530000);
INSERT INTO `cities` VALUES (972, 532800, '西双版纳傣族自治州', 530000);
INSERT INTO `cities` VALUES (973, 532900, '大理白族自治州', 530000);
INSERT INTO `cities` VALUES (974, 533100, '德宏傣族景颇族自治州', 530000);
INSERT INTO `cities` VALUES (975, 533300, '怒江傈僳族自治州', 530000);
INSERT INTO `cities` VALUES (976, 533400, '迪庆藏族自治州', 530000);
INSERT INTO `cities` VALUES (977, 540100, '拉萨市', 540000);
INSERT INTO `cities` VALUES (978, 542100, '昌都地区', 540000);
INSERT INTO `cities` VALUES (979, 542200, '山南地区', 540000);
INSERT INTO `cities` VALUES (980, 542300, '日喀则地区', 540000);
INSERT INTO `cities` VALUES (981, 542400, '那曲地区', 540000);
INSERT INTO `cities` VALUES (982, 542500, '阿里地区', 540000);
INSERT INTO `cities` VALUES (983, 542600, '林芝地区', 540000);
INSERT INTO `cities` VALUES (984, 610100, '西安市', 610000);
INSERT INTO `cities` VALUES (985, 610200, '铜川市', 610000);
INSERT INTO `cities` VALUES (986, 610300, '宝鸡市', 610000);
INSERT INTO `cities` VALUES (987, 610400, '咸阳市', 610000);
INSERT INTO `cities` VALUES (988, 610500, '渭南市', 610000);
INSERT INTO `cities` VALUES (989, 610600, '延安市', 610000);
INSERT INTO `cities` VALUES (990, 610700, '汉中市', 610000);
INSERT INTO `cities` VALUES (991, 610800, '榆林市', 610000);
INSERT INTO `cities` VALUES (992, 610900, '安康市', 610000);
INSERT INTO `cities` VALUES (993, 611000, '商洛市', 610000);
INSERT INTO `cities` VALUES (994, 620100, '兰州市', 620000);
INSERT INTO `cities` VALUES (995, 620200, '嘉峪关市', 620000);
INSERT INTO `cities` VALUES (996, 620300, '金昌市', 620000);
INSERT INTO `cities` VALUES (997, 620400, '白银市', 620000);
INSERT INTO `cities` VALUES (998, 620500, '天水市', 620000);
INSERT INTO `cities` VALUES (999, 620600, '武威市', 620000);
INSERT INTO `cities` VALUES (1000, 620700, '张掖市', 620000);
INSERT INTO `cities` VALUES (1001, 620800, '平凉市', 620000);
INSERT INTO `cities` VALUES (1002, 620900, '酒泉市', 620000);
INSERT INTO `cities` VALUES (1003, 621000, '庆阳市', 620000);
INSERT INTO `cities` VALUES (1004, 621100, '定西市', 620000);
INSERT INTO `cities` VALUES (1005, 621200, '陇南市', 620000);
INSERT INTO `cities` VALUES (1006, 622900, '临夏回族自治州', 620000);
INSERT INTO `cities` VALUES (1007, 623000, '甘南藏族自治州', 620000);
INSERT INTO `cities` VALUES (1008, 630100, '西宁市', 630000);
INSERT INTO `cities` VALUES (1009, 632100, '海东地区', 630000);
INSERT INTO `cities` VALUES (1010, 632200, '海北藏族自治州', 630000);
INSERT INTO `cities` VALUES (1011, 632300, '黄南藏族自治州', 630000);
INSERT INTO `cities` VALUES (1012, 632500, '海南藏族自治州', 630000);
INSERT INTO `cities` VALUES (1013, 632600, '果洛藏族自治州', 630000);
INSERT INTO `cities` VALUES (1014, 632700, '玉树藏族自治州', 630000);
INSERT INTO `cities` VALUES (1015, 632800, '海西蒙古族藏族自治州', 630000);
INSERT INTO `cities` VALUES (1016, 640100, '银川市', 640000);
INSERT INTO `cities` VALUES (1017, 640200, '石嘴山市', 640000);
INSERT INTO `cities` VALUES (1018, 640300, '吴忠市', 640000);
INSERT INTO `cities` VALUES (1019, 640400, '固原市', 640000);
INSERT INTO `cities` VALUES (1020, 640500, '中卫市', 640000);
INSERT INTO `cities` VALUES (1021, 650100, '乌鲁木齐市', 650000);
INSERT INTO `cities` VALUES (1022, 650200, '克拉玛依市', 650000);
INSERT INTO `cities` VALUES (1023, 652100, '吐鲁番地区', 650000);
INSERT INTO `cities` VALUES (1024, 652200, '哈密地区', 650000);
INSERT INTO `cities` VALUES (1025, 652300, '昌吉回族自治州', 650000);
INSERT INTO `cities` VALUES (1026, 652700, '博尔塔拉蒙古自治州', 650000);
INSERT INTO `cities` VALUES (1027, 652800, '巴音郭楞蒙古自治州', 650000);
INSERT INTO `cities` VALUES (1028, 652900, '阿克苏地区', 650000);
INSERT INTO `cities` VALUES (1029, 653000, '克孜勒苏柯尔克孜自治州', 650000);
INSERT INTO `cities` VALUES (1030, 653100, '喀什地区', 650000);
INSERT INTO `cities` VALUES (1031, 653200, '和田地区', 650000);
INSERT INTO `cities` VALUES (1032, 654000, '伊犁哈萨克自治州', 650000);
INSERT INTO `cities` VALUES (1033, 654200, '塔城地区', 650000);
INSERT INTO `cities` VALUES (1034, 654300, '阿勒泰地区', 650000);
INSERT INTO `cities` VALUES (1035, 659000, '省直辖行政单位', 650000);
...
CREATE TABLE `collections`  (
  ...
  `venuesid` int(11) DEFAULT NULL COMMENT '场馆编号',
  `state` int(255) DEFAULT 0 COMMENT '收藏状态0未收藏 1已收藏',
  `deletestate` int(255) DEFAULT 0 COMMENT '删除状态 0未删除1已删除',
  PRIMARY KEY (`collection_id`) USING BTREE,
  INDEX `userid`(`userid`) USING BTREE,
  INDEX `venuesid`(`venuesid`) USING BTREE,
  CONSTRAINT `collections_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `collections_ibfk_2` FOREIGN KEY (`venuesid`) REFERENCES `venues` (`venuesid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 347 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of collections
-- ----------------------------
INSERT INTO `collections` VALUES (1, 3, 1, 0, 0);
INSERT INTO `collections` VALUES (2, 2, 1, 0, 0);
INSERT INTO `collections` VALUES (3, 4, 1, 0, 0);
INSERT INTO `collections` VALUES (4, 5, 1, 0, 0);
INSERT INTO `collections` VALUES (5, 6, 1, 0, 0);
INSERT INTO `collections` VALUES (6, 7, 1, 0, 0);
INSERT INTO `collections` VALUES (7, 8, 1, 0, 0);
INSERT INTO `collections` VALUES (8, 9, 1, 0, 0);
INSERT INTO `collections` VALUES (9, 10, 1, 0, 0);
INSERT INTO `collections` VALUES (10, 11, 1, 0, 0);
INSERT INTO `collections` VALUES (11, 12, 1, 0, 0);
INSERT INTO `collections` VALUES (12, 13, 1, 0, 0);
INSERT INTO `collections` VALUES (13, 14, 1, 0, 0);
INSERT INTO `collections` VALUES (14, 15, 1, 0, 0);
INSERT INTO `collections` VALUES (15, 3, 2, 0, 0);
INSERT INTO `collections` VALUES (16, 2, 2, 0, 0);
INSERT INTO `collections` VALUES (17, 15, 2, 0, 0);
INSERT INTO `collections` VALUES (18, 4, 2, 0, 0);
INSERT INTO `collections` VALUES (19, 5, 2, 0, 0);
INSERT INTO `collections` VALUES (20, 6, 2, 0, 0);
INSERT INTO `collections` VALUES (21, 7, 2, 0, 0);
INSERT INTO `collections` VALUES (22, 8, 2, 0, 0);
INSERT INTO `collections` VALUES (23, 9, 2, 0, 0);
INSERT INTO `collections` VALUES (24, 10, 2, 0, 0);
INSERT INTO `collections` VALUES (25, 11, 2, 0, 0);
INSERT INTO `collections` VALUES (26, 12, 2, 0, 0);
INSERT INTO `collections` VALUES (27, 13, 2, 0, 0);
INSERT INTO `collections` VALUES (28, 14, 2, 0, 0);
INSERT INTO `collections` VALUES (29, 16, 1, 0, 0);
INSERT INTO `collections` VALUES (30, 16, 2, 0, 0);
INSERT INTO `collections` VALUES (31, 3, 3, 0, 0);
INSERT INTO `collections` VALUES (32, 2, 3, 0, 0);
INSERT INTO `collections` VALUES (33, 15, 3, 0, 0);
INSERT INTO `collections` VALUES (34, 16, 3, 0, 0);
INSERT INTO `collections` VALUES (35, 4, 3, 0, 0);
INSERT INTO `collections` VALUES (36, 5, 3, 0, 0);
INSERT INTO `collections` VALUES (37, 6, 3, 0, 0);
INSERT INTO `collections` VALUES (38, 7, 3, 0, 0);
INSERT INTO `collections` VALUES (39, 8, 3, 0, 0);
INSERT INTO `collections` VALUES (40, 9, 3, 0, 0);
INSERT INTO `collections` VALUES (41, 10, 3, 0, 0);
INSERT INTO `collections` VALUES (42, 11, 3, 0, 0);
INSERT INTO `collections` VALUES (43, 12, 3, 0, 0);
INSERT INTO `collections` VALUES (44, 13, 3, 0, 0);
INSERT INTO `collections` VALUES (45, 14, 3, 0, 0);
INSERT INTO `collections` VALUES (46, 3, 4, 0, 0);
INSERT INTO `collections` VALUES (47, 2, 4, 0, 0);
INSERT INTO `collections` VALUES (48, 15, 4, 0, 0);
INSERT INTO `collections` VALUES (49, 16, 4, 0, 0);
INSERT INTO `collections` VALUES (50, 4, 4, 0, 0);
INSERT INTO `collections` VALUES (51, 5, 4, 0, 0);
INSERT INTO `collections` VALUES (52, 6, 4, 0, 0);
INSERT INTO `collections` VALUES (53, 7, 4, 0, 0);
INSERT INTO `collections` VALUES (54, 8, 4, 0, 0);
INSERT INTO `collections` VALUES (55, 9, 4, 0, 0);
INSERT INTO `collections` VALUES (56, 10, 4, 0, 0);
INSERT INTO `collections` VALUES (57, 11, 4, 0, 0);
INSERT INTO `collections` VALUES (58, 12, 4, 0, 0);
INSERT INTO `collections` VALUES (59, 13, 4, 0, 0);
INSERT INTO `collections` VALUES (60, 14, 4, 0, 0);
INSERT INTO `collections` VALUES (61, 3, 5, 0, 0);
INSERT INTO `collections` VALUES (62, 2, 5, 0, 0);
INSERT INTO `collections` VALUES (63, 15, 5, 0, 0);
INSERT INTO `collections` VALUES (64, 16, 5, 0, 0);
INSERT INTO `collections` VALUES (65, 4, 5, 0, 0);
INSERT INTO `collections` VALUES (66, 5, 5, 0, 0);
INSERT INTO `collections` VALUES (67, 6, 5, 0, 0);
INSERT INTO `collections` VALUES (68, 7, 5, 0, 0);
INSERT INTO `collections` VALUES (69, 8, 5, 0, 0);
INSERT INTO `collections` VALUES (70, 9, 5, 0, 0);
INSERT INTO `collections` VALUES (71, 10, 5, 0, 0);
INSERT INTO `collections` VALUES (72, 11, 5, 0, 0);
INSERT INTO `collections` VALUES (73, 12, 5, 0, 0);
INSERT INTO `collections` VALUES (74, 13, 5, 0, 0);
INSERT INTO `collections` VALUES (75, 14, 5, 0, 0);
INSERT INTO `collections` VALUES (76, 3, 6, 0, 0);
INSERT INTO `collections` VALUES (77, 2, 6, 0, 0);
INSERT INTO `collections` VALUES (78, 15, 6, 0, 0);
INSERT INTO `collections` VALUES (79, 16, 6, 0, 0);
INSERT INTO `collections` VALUES (80, 4, 6, 0, 0);
INSERT INTO `collections` VALUES (81, 5, 6, 0, 0);
INSERT INTO `collections` VALUES (82, 6, 6, 0, 0);
INSERT INTO `collections` VALUES (83, 7, 6, 0, 0);
INSERT INTO `collections` VALUES (84, 8, 6, 0, 0);
INSERT INTO `collections` VALUES (85, 9, 6, 0, 0);
INSERT INTO `collections` VALUES (86, 10, 6, 0, 0);
INSERT INTO `collections` VALUES (87, 11, 6, 0, 0);
INSERT INTO `collections` VALUES (88, 12, 6, 0, 0);
INSERT INTO `collections` VALUES (89, 13, 6, 0, 0);
INSERT INTO `collections` VALUES (90, 14, 6, 0, 0);
INSERT INTO `collections` VALUES (91, 17, 1, 0, 0);
INSERT INTO `collections` VALUES (92, 17, 2, 0, 0);
INSERT INTO `collections` VALUES (93, 17, 3, 0, 0);
INSERT INTO `collections` VALUES (94, 17, 4, 0, 0);
INSERT INTO `collections` VALUES (95, 17, 5, 0, 0);
INSERT INTO `collections` VALUES (96, 17, 6, 0, 0);
INSERT INTO `collections` VALUES (97, 18, 1, 0, 0);
INSERT INTO `collections` VALUES (98, 18, 2, 0, 0);
INSERT INTO `collections` VALUES (99, 18, 3, 0, 0);
INSERT INTO `collections` VALUES (100, 18, 4, 0, 0);
INSERT INTO `collections` VALUES (101, 18, 5, 0, 0);
INSERT INTO `collections` VALUES (102, 18, 6, 0, 0);
INSERT INTO `collections` VALUES (103, 19, 1, 0, 0);
INSERT INTO `collections` VALUES (104, 19, 2, 0, 0);
INSERT INTO `collections` VALUES (105, 19, 3, 0, 0);
INSERT INTO `collections` VALUES (106, 19, 4, 0, 0);
INSERT INTO `collections` VALUES (107, 19, 5, 0, 0);
INSERT INTO `collections` VALUES (108, 19, 6, 0, 0);
INSERT INTO `collections` VALUES (109, 3, 7, 0, 0);
INSERT INTO `collections` VALUES (110, 2, 7, 0, 0);
INSERT INTO `collections` VALUES (111, 15, 7, 0, 0);
INSERT INTO `collections` VALUES (112, 16, 7, 0, 0);
INSERT INTO `collections` VALUES (113, 19, 7, 0, 0);
INSERT INTO `collections` VALUES (114, 4, 7, 0, 0);
INSERT INTO `collections` VALUES (115, 5, 7, 0, 0);
INSERT INTO `collections` VALUES (116, 6, 7, 0, 0);
INSERT INTO `collections` VALUES (117, 7, 7, 0, 0);
INSERT INTO `collections` VALUES (118, 8, 7, 0, 0);
INSERT INTO `collections` VALUES (119, 9, 7, 0, 0);
INSERT INTO `collections` VALUES (120, 10, 7, 0, 0);
INSERT INTO `collections` VALUES (121, 11, 7, 0, 0);
INSERT INTO `collections` VALUES (122, 12, 7, 0, 0);
INSERT INTO `collections` VALUES (123, 13, 7, 0, 0);
INSERT INTO `collections` VALUES (124, 14, 7, 0, 0);
INSERT INTO `collections` VALUES (125, 17, 7, 0, 0);
INSERT INTO `collections` VALUES (126, 18, 7, 0, 0);
INSERT INTO `collections` VALUES (153, 21, 1, 0, 0);
INSERT INTO `collections` VALUES (154, 21, 2, 0, 0);
INSERT INTO `collections` VALUES (155, 21, 3, 0, 0);
INSERT INTO `collections` VALUES (156, 21, 4, 0, 0);
INSERT INTO `collections` VALUES (157, 21, 5, 0, 0);
INSERT INTO `collections` VALUES (158, 21, 6, 0, 0);
INSERT INTO `collections` VALUES (159, 21, 7, 0, 0);
INSERT INTO `collections` VALUES (160, 22, 1, 0, 0);
INSERT INTO `collections` VALUES (161, 22, 2, 0, 0);
INSERT INTO `collections` VALUES (162, 22, 3, 0, 0);
INSERT INTO `collections` VALUES (163, 22, 4, 0, 0);
INSERT INTO `collections` VALUES (164, 22, 5, 0, 0);
INSERT INTO `collections` VALUES (165, 22, 6, 0, 0);
INSERT INTO `collections` VALUES (166, 22, 7, 0, 0);
INSERT INTO `collections` VALUES (167, 3, 8, 0, 0);
INSERT INTO `collections` VALUES (168, 2, 8, 0, 0);
INSERT INTO `collections` VALUES (169, 15, 8, 0, 0);
INSERT INTO `collections` VALUES (170, 16, 8, 0, 0);
INSERT INTO `collections` VALUES (171, 19, 8, 0, 0);
INSERT INTO `collections` VALUES (172, 21, 8, 0, 0);
INSERT INTO `collections` VALUES (173, 4, 8, 0, 0);
INSERT INTO `collections` VALUES (174, 5, 8, 0, 0);
INSERT INTO `collections` VALUES (175, 6, 8, 0, 0);
INSERT INTO `collections` VALUES (176, 7, 8, 0, 0);
INSERT INTO `collections` VALUES (177, 8, 8, 0, 0);
INSERT INTO `collections` VALUES (178, 9, 8, 0, 0);
INSERT INTO `collections` VALUES (179, 10, 8, 0, 0);
INSERT INTO `collections` VALUES (180, 11, 8, 0, 0);
INSERT INTO `collections` VALUES (181, 12, 8, 0, 0);
INSERT INTO `collections` VALUES (182, 13, 8, 0, 0);
INSERT INTO `collections` VALUES (183, 14, 8, 0, 0);
INSERT INTO `collections` VALUES (184, 17, 8, 0, 0);
INSERT INTO `collections` VALUES (185, 18, 8, 0, 0);
INSERT INTO `collections` VALUES (186, 22, 8, 0, 0);
INSERT INTO `collections` VALUES (187, 23, 1, 0, 0);
INSERT INTO `collections` VALUES (188, 23, 2, 0, 0);
INSERT INTO `collections` VALUES (189, 23, 3, 0, 0);
INSERT INTO `collections` VALUES (190, 23, 4, 0, 0);
INSERT INTO `collections` VALUES (191, 23, 5, 0, 0);
INSERT INTO `collections` VALUES (192, 23, 6, 0, 0);
INSERT INTO `collections` VALUES (193, 23, 7, 0, 0);
INSERT INTO `collections` VALUES (194, 23, 8, 0, 0);
INSERT INTO `collections` VALUES (203, 25, 1, 1, 0);
INSERT INTO `collections` VALUES (204, 25, 2, 0, 0);
INSERT INTO `collections` VALUES (205, 25, 3, 1, 0);
INSERT INTO `collections` VALUES (206, 25, 4, 1, 0);
INSERT INTO `collections` VALUES (207, 25, 5, 0, 0);
INSERT INTO `collections` VALUES (208, 25, 6, 0, 0);
INSERT INTO `collections` VALUES (209, 25, 7, 0, 0);
INSERT INTO `collections` VALUES (210, 25, 8, 0, 0);
INSERT INTO `collections` VALUES (211, 26, 1, 0, 0);
INSERT INTO `collections` VALUES (212, 26, 2, 0, 0);
INSERT INTO `collections` VALUES (213, 26, 3, 0, 0);
INSERT INTO `collections` VALUES (214, 26, 4, 0, 0);
INSERT INTO `collections` VALUES (215, 26, 5, 0, 0);
INSERT INTO `collections` VALUES (216, 26, 6, 0, 0);
INSERT INTO `collections` VALUES (217, 26, 7, 0, 0);
INSERT INTO `collections` VALUES (218, 26, 8, 0, 0);
INSERT INTO `collections` VALUES (219, 27, 1, 0, 0);
INSERT INTO `collections` VALUES (220, 27, 2, 0, 0);
INSERT INTO `collections` VALUES (221, 27, 3, 0, 0);
INSERT INTO `collections` VALUES (222, 27, 4, 0, 0);
INSERT INTO `collections` VALUES (223, 27, 5, 0, 0);
INSERT INTO `collections` VALUES (224, 27, 6, 0, 0);
INSERT INTO `collections` VALUES (225, 27, 7, 0, 0);
INSERT INTO `collections` VALUES (226, 27, 8, 0, 0);
INSERT INTO `collections` VALUES (227, 3, 9, 0, 0);
INSERT INTO `collections` VALUES (228, 2, 9, 0, 0);
INSERT INTO `collections` VALUES (229, 15, 9, 0, 0);
INSERT INTO `collections` VALUES (230, 16, 9, 0, 0);
INSERT INTO `collections` VALUES (231, 19, 9, 0, 0);
INSERT INTO `collections` VALUES (232, 21, 9, 0, 0);
INSERT INTO `collections` VALUES (233, 4, 9, 0, 0);
INSERT INTO `collections` VALUES (234, 5, 9, 0, 0);
INSERT INTO `collections` VALUES (235, 6, 9, 0, 0);
INSERT INTO `collections` VALUES (236, 7, 9, 0, 0);
INSERT INTO `collections` VALUES (237, 8, 9, 0, 0);
INSERT INTO `collections` VALUES (238, 9, 9, 0, 0);
INSERT INTO `collections` VALUES (239, 10, 9, 0, 0);
INSERT INTO `collections` VALUES (240, 11, 9, 0, 0);
INSERT INTO `collections` VALUES (241, 12, 9, 0, 0);
INSERT INTO `collections` VALUES (242, 13, 9, 0, 0);
INSERT INTO `collections` VALUES (243, 14, 9, 0, 0);
INSERT INTO `collections` VALUES (244, 17, 9, 0, 0);
INSERT INTO `collections` VALUES (245, 18, 9, 0, 0);
INSERT INTO `collections` VALUES (246, 22, 9, 0, 0);
INSERT INTO `collections` VALUES (247, 23, 9, 0, 0);
INSERT INTO `collections` VALUES (248, 25, 9, 0, 0);
INSERT INTO `collections` VALUES (249, 26, 9, 0, 0);
INSERT INTO `collections` VALUES (250, 27, 9, 0, 0);
INSERT INTO `collections` VALUES (251, 3, 10, 0, 0);
INSERT INTO `collections` VALUES (252, 2, 10, 0, 0);
INSERT INTO `collections` VALUES (253, 15, 10, 0, 0);
INSERT INTO `collections` VALUES (254, 16, 10, 0, 0);
INSERT INTO `collections` VALUES (255, 19, 10, 0, 0);
INSERT INTO `collections` VALUES (256, 21, 10, 0, 0);
INSERT INTO `collections` VALUES (257, 4, 10, 0, 0);
INSERT INTO `collections` VALUES (258, 5, 10, 0, 0);
INSERT INTO `collections` VALUES (259, 6, 10, 0, 0);
INSERT INTO `collections` VALUES (260, 7, 10, 0, 0);
INSERT INTO `collections` VALUES (261, 8, 10, 0, 0);
INSERT INTO `collections` VALUES (262, 9, 10, 0, 0);
INSERT INTO `collections` VALUES (263, 10, 10, 0, 0);
INSERT INTO `collections` VALUES (264, 11, 10, 0, 0);
INSERT INTO `collections` VALUES (265, 12, 10, 0, 0);
INSERT INTO `collections` VALUES (266, 13, 10, 0, 0);
INSERT INTO `collections` VALUES (267, 14, 10, 0, 0);
INSERT INTO `collections` VALUES (268, 17, 10, 0, 0);
INSERT INTO `collections` VALUES (269, 18, 10, 0, 0);
INSERT INTO `collections` VALUES (270, 22, 10, 0, 0);
INSERT INTO `collections` VALUES (271, 23, 10, 0, 0);
INSERT INTO `collections` VALUES (272, 25, 10, 0, 0);
INSERT INTO `collections` VALUES (273, 26, 10, 0, 0);
INSERT INTO `collections` VALUES (274, 27, 10, 0, 0);
INSERT INTO `collections` VALUES (275, 3, 11, 0, 0);
INSERT INTO `collections` VALUES (276, 2, 11, 0, 0);
INSERT INTO `collections` VALUES (277, 15, 11, 0, 0);
INSERT INTO `collections` VALUES (278, 16, 11, 0, 0);
INSERT INTO `collections` VALUES (279, 19, 11, 0, 0);
INSERT INTO `collections` VALUES (280, 21, 11, 0, 0);
INSERT INTO `collections` VALUES (281, 4, 11, 0, 0);
INSERT INTO `collections` VALUES (282, 5, 11, 0, 0);
INSERT INTO `collections` VALUES (283, 6, 11, 0, 0);
INSERT INTO `collections` VALUES (284, 7, 11, 0, 0);
INSERT INTO `collections` VALUES (285, 8, 11, 0, 0);
INSERT INTO `collections` VALUES (286, 9, 11, 0, 0);
INSERT INTO `collections` VALUES (287, 10, 11, 0, 0);
INSERT INTO `collections` VALUES (288, 11, 11, 0, 0);
INSERT INTO `collections` VALUES (289, 12, 11, 0, 0);
INSERT INTO `collections` VALUES (290, 13, 11, 0, 0);
INSERT INTO `collections` VALUES (291, 14, 11, 0, 0);
INSERT INTO `collections` VALUES (292, 17, 11, 0, 0);
INSERT INTO `collections` VALUES (293, 18, 11, 0, 0);
INSERT INTO `collections` VALUES (294, 22, 11, 0, 0);
INSERT INTO `collections` VALUES (295, 23, 11, 0, 0);
INSERT INTO `collections` VALUES (296, 25, 11, 0, 0);
INSERT INTO `collections` VALUES (297, 26, 11, 0, 0);
INSERT INTO `collections` VALUES (298, 27, 11, 0, 0);
INSERT INTO `collections` VALUES (299, 3, 12, 0, 0);
INSERT INTO `collections` VALUES (300, 2, 12, 0, 0);
INSERT INTO `collections` VALUES (301, 15, 12, 0, 0);
INSERT INTO `collections` VALUES (302, 16, 12, 0, 0);
INSERT INTO `collections` VALUES (303, 19, 12, 0, 0);
INSERT INTO `collections` VALUES (304, 21, 12, 0, 0);
INSERT INTO `collections` VALUES (305, 4, 12, 0, 0);
INSERT INTO `collections` VALUES (306, 5, 12, 0, 0);
INSERT INTO `collections` VALUES (307, 6, 12, 0, 0);
INSERT INTO `collections` VALUES (308, 7, 12, 0, 0);
INSERT INTO `collections` VALUES (309, 8, 12, 0, 0);
INSERT INTO `collections` VALUES (310, 9, 12, 0, 0);
INSERT INTO `collections` VALUES (311, 10, 12, 0, 0);
INSERT INTO `collections` VALUES (312, 11, 12, 0, 0);
INSERT INTO `collections` VALUES (313, 12, 12, 0, 0);
INSERT INTO `collections` VALUES (314, 13, 12, 0, 0);
INSERT INTO `collections` VALUES (315, 14, 12, 0, 0);
INSERT INTO `collections` VALUES (316, 17, 12, 0, 0);
INSERT INTO `collections` VALUES (317, 18, 12, 0, 0);
INSERT INTO `collections` VALUES (318, 22, 12, 0, 0);
INSERT INTO `collections` VALUES (319, 23, 12, 0, 0);
INSERT INTO `collections` VALUES (320, 25, 12, 0, 0);
INSERT INTO `collections` VALUES (321, 26, 12, 0, 0);
INSERT INTO `collections` VALUES (322, 27, 12, 0, 0);
INSERT INTO `collections` VALUES (323, 3, 13, 0, 0);
INSERT INTO `collections` VALUES (324, 2, 13, 0, 0);
INSERT INTO `collections` VALUES (325, 15, 13, 0, 0);
INSERT INTO `collections` VALUES (326, 16, 13, 0, 0);
INSERT INTO `collections` VALUES (327, 19, 13, 0, 0);
INSERT INTO `collections` VALUES (328, 21, 13, 0, 0);
INSERT INTO `collections` VALUES (329, 4, 13, 0, 0);
INSERT INTO `collections` VALUES (330, 5, 13, 0, 0);
INSERT INTO `collections` VALUES (331, 6, 13, 0, 0);
INSERT INTO `collections` VALUES (332, 7, 13, 0, 0);
INSERT INTO `collections` VALUES (333, 8, 13, 0, 0);
INSERT INTO `collections` VALUES (334, 9, 13, 0, 0);
INSERT INTO `collections` VALUES (335, 10, 13, 0, 0);
INSERT INTO `collections` VALUES (336, 11, 13, 0, 0);
INSERT INTO `collections` VALUES (337, 12, 13, 0, 0);
INSERT INTO `collections` VALUES (338, 13, 13, 0, 0);
INSERT INTO `collections` VALUES (339, 14, 13, 0, 0);
INSERT INTO `collections` VALUES (340, 17, 13, 0, 0);
INSERT INTO `collections` VALUES (341, 18, 13, 0, 0);
INSERT INTO `collections` VALUES (342, 22, 13, 0, 0);
INSERT INTO `collections` VALUES (343, 23, 13, 0, 0);
INSERT INTO `collections` VALUES (344, 25, 13, 0, 0);
INSERT INTO `collections` VALUES (345, 26, 13, 0, 0);
INSERT INTO `collections` VALUES (346, 27, 13, 0, 0);
...
CREATE TABLE `menu`  (
  `id` int(11) DEFAULT NULL COMMENT '子id',
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1325, 2, '总目录', 'closed', 'fa fa-user', '', 205, NULL, '2018-03-31 10:07:30');
INSERT INTO `menu` VALUES (1346001, 214, '页面布局说明', 'open', '', 'http://www.topjui.com/guider.html', 214, NULL, NULL);
INSERT INTO `menu` VALUES (1348001, 214, '引用外部页面', 'open', '', 'http://www.topjui.com/guider.html', 215, NULL, NULL);
INSERT INTO `menu` VALUES (1347001, 214, '内置icon图标', 'open', '', 'http://www.topjui.com/guider.html', 216, NULL, NULL);
INSERT INTO `menu` VALUES (1350, 1325, '系统设置', 'closed', 'fa fa-heartbeat', '', 244, NULL, '2018-03-31 14:14:19');
INSERT INTO `menu` VALUES (1111, 1350, '菜单管理', 'open', NULL, '/menu/findmenu.action', 331, '2018-03-31 14:15:16', '2018-03-31 14:19:48');
INSERT INTO `menu` VALUES (11, 1350, '用户信息管理', 'open', NULL, '/user/showuserjsp.action', 332, '2018-03-31 14:18:25', '2018-03-31 14:19:00');
INSERT INTO `menu` VALUES (123, 1325, '场馆管理', 'closed', NULL, 'q', 333, '2018-04-03 14:31:50', NULL);
INSERT INTO `menu` VALUES (1233, 123, '场馆管理', 'open', NULL, '/venues/findvenues.action', 334, '2018-04-03 14:33:05', '2018-04-03 14:34:21');
INSERT INTO `menu` VALUES (12334, 1325, '场馆活动管理', 'closed', NULL, '', 335, '2018-04-25 22:40:30', NULL);
INSERT INTO `menu` VALUES (12, 12334, '场馆活动管理', 'open', NULL, '/participatevenuesactivity/findjsp.action', 336, '2018-04-25 22:41:32', NULL);
INSERT INTO `menu` VALUES (12344, 1325, '用户自定义活动管理', 'closed', NULL, '', 337, '2018-04-30 12:54:22', NULL);
INSERT INTO `menu` VALUES (123445, 12344, '自定义活动管理', 'open', NULL, '/usercustomer//findusercustomerAct.action', 338, '2018-04-30 12:55:16', NULL);
...
CREATE TABLE `orders`  (
  ...
  `userid` int(11) DEFAULT NULL COMMENT '用户编号',
  `income_state` int(255) DEFAULT NULL COMMENT '收入状态 1收入 -1支出',
  `money` decimal(65, 2) DEFAULT NULL COMMENT '金额',
  `cause` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '支付详情',
  `income_user_id` int(11) DEFAULT NULL COMMENT '收款人id',
  `medium` int(255) DEFAULT NULL COMMENT '支付手段（账户或者银行卡）',
  `time` datetime(0) DEFAULT NULL COMMENT '订单时间',
  `deletestate` int(255) DEFAULT 0 COMMENT '删除状态0未删除1已删除',
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, 11, 1, 123.00, '3通过平台向11充值:123', 3, 3, '2018-04-02 15:18:53', 0);
INSERT INTO `orders` VALUES (2, 3, -1, 123.00, '3通过平台向11充值:123', 11, 3, '2018-04-02 15:18:53', 0);
INSERT INTO `orders` VALUES (3, 11, 1, 1233.00, '3通过平台向11充值:1233', 3, 3, '2018-04-02 20:44:49', 0);
INSERT INTO `orders` VALUES (4, 3, -1, 1233.00, '3通过平台向11充值:1233', 11, 3, '2018-04-02 20:44:49', 0);
INSERT INTO `orders` VALUES (5, 5, 1, 213.00, '3通过平台向5充值:213', 3, 3, '2018-04-02 20:45:05', 0);
INSERT INTO `orders` VALUES (6, 3, -1, 213.00, '3通过平台向5充值:213', 5, 3, '2018-04-02 20:45:05', 0);
INSERT INTO `orders` VALUES (7, 12, 1, 123.00, '3通过平台向12充值:123', 3, 3, '2018-04-02 20:45:45', 0);
INSERT INTO `orders` VALUES (8, 3, -1, 123.00, '3通过平台向12充值:123', 12, 3, '2018-04-02 20:45:45', 0);
INSERT INTO `orders` VALUES (9, 10, 1, 66666666666666.00, '3通过平台向10充值:66666666666666', 3, 3, '2018-04-03 09:13:52', 0);
INSERT INTO `orders` VALUES (10, 3, -1, 66666666666666.00, '3通过平台向10充值:66666666666666', 10, 3, '2018-04-03 09:13:52', 0);
INSERT INTO `orders` VALUES (11, 18, 1, 1000000000.00, '3通过平台向18充值:1000000000', 3, 3, '2018-04-06 15:44:36', 0);
INSERT INTO `orders` VALUES (12, 3, -1, 1000000000.00, '3通过平台向18充值:1000000000', 18, 3, '2018-04-06 15:44:36', 0);
INSERT INTO `orders` VALUES (13, 19, 1, 8000000000000000.00, '3通过平台向19充值:8000000000000000', 3, 3, '2018-04-06 16:37:50', 0);
INSERT INTO `orders` VALUES (14, 3, -1, 8000000000000000.00, '3通过平台向19充值:8000000000000000', 19, 3, '2018-04-06 16:37:50', 0);
INSERT INTO `orders` VALUES (15, 10, 1, 200000000.00, '3通过平台向10充值:200000000', 3, 3, '2018-04-10 22:14:48', 0);
INSERT INTO `orders` VALUES (16, 3, -1, 200000000.00, '3通过平台向10充值:200000000', 10, 3, '2018-04-10 22:14:48', 0);
INSERT INTO `orders` VALUES (19, 27, 1, 999999999999.00, '3通过平台向27充值:999999999999', 3, 3, '2018-04-15 14:42:40', 0);
INSERT INTO `orders` VALUES (20, 3, -1, 999999999999.00, '3通过平台向27充值:999999999999', 27, 3, '2018-04-15 14:42:40', 0);
INSERT INTO `orders` VALUES (21, 27, 1, 99999999999999.00, '3通过平台向27充值:99999999999999', 3, 3, '2018-04-15 14:43:07', 0);
INSERT INTO `orders` VALUES (22, 3, -1, 99999999999999.00, '3通过平台向27充值:99999999999999', 27, 3, '2018-04-15 14:43:07', 0);
INSERT INTO `orders` VALUES (23, 25, 1, 1000.00, '黄哥帅666通过充值收入1000.00积分', 3, 2, '2018-04-24 21:27:11', 0);
INSERT INTO `orders` VALUES (24, 3, -1, 1000.00, '黄成成通过支出收入1000.00积分给用户com.xzit.entity.User@2058964a充值', 25, 2, '2018-04-24 21:27:11', 0);
INSERT INTO `orders` VALUES (25, 25, 1, 1200.00, '黄哥帅666通过充值收入1200.00积分', 3, 2, '2018-04-24 21:27:34', 0);
INSERT INTO `orders` VALUES (26, 3, -1, 1200.00, '黄成成通过支出收入1200.00积分给用户com.xzit.entity.User@32a66a58充值', 25, 2, '2018-04-24 21:27:34', 0);
INSERT INTO `orders` VALUES (27, 25, 1, 1000.00, '黄哥帅666通过充值收入1000积分', 3, 2, '2018-04-24 21:33:01', 0);
INSERT INTO `orders` VALUES (28, 3, -1, 3200.00, '黄成成通过支出收入1000积分给用户com.xzit.entity.User@593b5454充值', 25, 2, '2018-04-24 21:33:01', 0);
INSERT INTO `orders` VALUES (29, 25, 1, 1000.00, '黄哥帅666通过充值收入1000积分', 3, 2, '2018-04-24 21:33:45', 0);
INSERT INTO `orders` VALUES (30, 3, -1, 4200.00, '黄成成通过支出收入1000积分给用户com.xzit.entity.User@10f813b8充值', 25, 2, '2018-04-24 21:33:45', 0);
INSERT INTO `orders` VALUES (31, 25, 1, 1000.00, '黄哥帅666通过充值收入1000积分', 3, 2, '2018-04-24 21:53:36', 0);
INSERT INTO `orders` VALUES (32, 3, -1, 5200.00, '黄成成通过支出收入1000积分给用户com.xzit.entity.User@47adbf6a充值', 25, 2, '2018-04-24 21:53:36', 0);
INSERT INTO `orders` VALUES (33, 25, 1, 1248993.00, '黄哥帅666通过充值收入1248993积分', 3, 2, '2018-04-24 21:53:45', 0);
INSERT INTO `orders` VALUES (34, 3, -1, 1254193.00, '黄成成通过支出收入1248993积分给用户com.xzit.entity.User@25855c3充值', 25, 2, '2018-04-24 21:53:45', 0);
INSERT INTO `orders` VALUES (35, 25, 1, 0.00, '黄哥帅666通过充值收入0积分', 3, 2, '2018-04-24 21:54:43', 0);
INSERT INTO `orders` VALUES (36, 3, -1, 1254193.00, '黄成成通过支出收入0积分给用户com.xzit.entity.User@436ab423充值', 25, 2, '2018-04-24 21:54:43', 0);
INSERT INTO `orders` VALUES (37, 25, 1, 1000.00, '黄哥帅666通过充值收入1000积分', 3, 2, '2018-04-24 21:56:18', 0);
INSERT INTO `orders` VALUES (38, 3, -1, 1255193.00, '黄成成通过支出收入1000积分给用户com.xzit.entity.User@44f5b824充值', 25, 2, '2018-04-24 21:56:18', 0);
INSERT INTO `orders` VALUES (39, 25, 1, 1000.00, '黄哥帅666通过充值收入1000积分', 3, 2, '2018-04-24 22:22:11', 0);
INSERT INTO `orders` VALUES (40, 3, -1, 1256193.00, '黄成成通过支出收入1000积分给用户com.xzit.entity.User@7cd45ae5充值', 25, 2, '2018-04-24 22:22:11', 0);
INSERT INTO `orders` VALUES (41, 25, 1, 10.00, '黄哥帅666通过充值收入10积分', 3, 2, '2018-04-25 10:31:37', 0);
INSERT INTO `orders` VALUES (42, 3, -1, 1256203.00, '黄成成通过支出收入10积分给用户黄哥帅666充值', 25, 2, '2018-04-25 10:31:37', 0);
INSERT INTO `orders` VALUES (43, 25, 1, 1000.00, '黄哥帅666通过充值收入1000积分', 3, 2, '2018-04-25 10:33:19', 0);
INSERT INTO `orders` VALUES (44, 3, -1, 1257203.00, '黄成成通过支出收入1000积分给用户黄哥帅666充值', 25, 2, '2018-04-25 10:33:19', 0);
INSERT INTO `orders` VALUES (45, 25, 1, 111.00, '3通过平台向25充值:111', 3, 3, '2018-04-25 10:58:47', 0);
INSERT INTO `orders` VALUES (46, 3, -1, 111.00, '3通过平台向25充值:111', 25, 3, '2018-04-25 10:58:47', 0);
INSERT INTO `orders` VALUES (47, 25, -1, 140.00, '黄哥帅666通过积分支出140.00', 2, 1, '2018-04-25 13:46:33', 0);
INSERT INTO `orders` VALUES (48, 2, 1, 1257174.00, '44通过积分支出140.00', 25, 1, '2018-04-25 13:46:33', 0);
INSERT INTO `orders` VALUES (49, 25, -1, 1200.00, '黄哥帅666通过积分支出1200.00', 2, 1, '2018-04-25 13:47:43', 0);
INSERT INTO `orders` VALUES (50, 2, 1, 1255974.00, '44通过积分支出1200.00', 25, 1, '2018-04-25 13:47:43', 0);
INSERT INTO `orders` VALUES (51, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-25 13:50:46', 0);
INSERT INTO `orders` VALUES (52, 2, 1, 1254574.00, '44通过积分支出1400.00', 25, 1, '2018-04-25 13:50:46', 0);
INSERT INTO `orders` VALUES (53, 25, -1, 140.00, '黄哥帅666通过积分支出140.00', 2, 1, '2018-04-25 20:49:13', 0);
INSERT INTO `orders` VALUES (54, 2, 1, 1254434.00, '44通过积分支出140.00', 25, 1, '2018-04-25 20:49:13', 0);
INSERT INTO `orders` VALUES (55, 25, -1, 140.00, '黄哥帅666通过积分支出140.00', 2, 1, '2018-04-25 21:01:10', 0);
INSERT INTO `orders` VALUES (56, 2, 1, 1254294.00, '44通过积分支出140.00', 25, 1, '2018-04-25 21:01:10', 0);
INSERT INTO `orders` VALUES (57, 25, -1, 140.00, '黄哥帅666通过积分支出140.00', 2, 1, '2018-04-25 21:01:27', 0);
INSERT INTO `orders` VALUES (58, 2, 1, 1254154.00, '44通过积分支出140.00', 25, 1, '2018-04-25 21:01:27', 0);
INSERT INTO `orders` VALUES (59, 25, -1, 20.00, '黄哥帅666通过积分支出20.00', 15, 1, '2018-04-26 09:30:37', 0);
INSERT INTO `orders` VALUES (60, 15, 1, 1254134.00, '孙立通过积分支出20.00', 25, 1, '2018-04-26 09:30:37', 0);
INSERT INTO `orders` VALUES (61, 25, -1, 140.00, '黄哥帅666通过积分支出140.00', 2, 1, '2018-04-26 09:35:10', 0);
INSERT INTO `orders` VALUES (62, 2, 1, 1253994.00, '44通过积分支出140.00', 25, 1, '2018-04-26 09:35:10', 0);
INSERT INTO `orders` VALUES (63, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 09:40:51', 0);
INSERT INTO `orders` VALUES (64, 2, 1, 1252594.00, '44通过积分支出1400.00', 25, 1, '2018-04-26 09:40:51', 0);
INSERT INTO `orders` VALUES (65, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 09:43:20', 0);
INSERT INTO `orders` VALUES (66, 2, 1, 1251194.00, '44通过积分支出1400.00', 25, 1, '2018-04-26 09:43:20', 0);
INSERT INTO `orders` VALUES (67, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 09:45:59', 0);
INSERT INTO `orders` VALUES (68, 2, 1, 1249794.00, '44通过积分支出1400.00', 25, 1, '2018-04-26 09:45:59', 0);
INSERT INTO `orders` VALUES (69, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 09:49:17', 0);
INSERT INTO `orders` VALUES (70, 2, 1, 1248394.00, '44通过积分支出1400.00', 25, 1, '2018-04-26 09:49:17', 0);
INSERT INTO `orders` VALUES (71, 25, -1, 140.00, '黄哥帅666通过积分支出140.00', 2, 1, '2018-04-26 15:31:56', 0);
INSERT INTO `orders` VALUES (72, 2, 1, 1248254.00, '44通过积分收入140.00', 25, 1, '2018-04-26 15:31:56', 0);
INSERT INTO `orders` VALUES (73, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 15:36:38', 0);
INSERT INTO `orders` VALUES (74, 2, 1, 1246854.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 15:36:38', 0);
INSERT INTO `orders` VALUES (75, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 19:54:09', 0);
INSERT INTO `orders` VALUES (76, 2, 1, 1245454.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 19:54:09', 0);
INSERT INTO `orders` VALUES (77, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 19:54:13', 0);
INSERT INTO `orders` VALUES (78, 2, 1, 1244054.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 19:54:13', 0);
INSERT INTO `orders` VALUES (79, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 19:56:05', 0);
INSERT INTO `orders` VALUES (80, 2, 1, 1242654.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 19:56:05', 0);
INSERT INTO `orders` VALUES (81, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 19:57:06', 0);
INSERT INTO `orders` VALUES (82, 2, 1, 1241254.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 19:57:06', 0);
INSERT INTO `orders` VALUES (83, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 19:57:23', 0);
INSERT INTO `orders` VALUES (84, 2, 1, 1239854.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 19:57:23', 0);
INSERT INTO `orders` VALUES (85, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 19:58:16', 0);
INSERT INTO `orders` VALUES (86, 2, 1, 1238454.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 19:58:16', 0);
INSERT INTO `orders` VALUES (87, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 19:58:53', 0);
INSERT INTO `orders` VALUES (88, 2, 1, 1237054.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 19:58:53', 0);
INSERT INTO `orders` VALUES (89, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 20:07:45', 0);
INSERT INTO `orders` VALUES (90, 2, 1, 1235654.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 20:07:45', 0);
INSERT INTO `orders` VALUES (91, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-26 21:00:32', 0);
INSERT INTO `orders` VALUES (92, 2, 1, 1234254.00, '44通过积分收入1400.00', 25, 1, '2018-04-26 21:00:32', 0);
INSERT INTO `orders` VALUES (93, 25, 1, 140.00, '黄哥帅666通过积分收入140.00', 2, 1, '2018-04-26 21:03:36', 0);
INSERT INTO `orders` VALUES (94, 2, -1, 1234394.00, '44通过积分支出140.00', 25, 1, '2018-04-26 21:03:36', 0);
INSERT INTO `orders` VALUES (95, 25, 1, 140.00, '黄哥帅666通过积分收入140.00', 2, 1, '2018-04-26 21:08:20', 0);
INSERT INTO `orders` VALUES (96, 2, -1, 1234534.00, '44通过积分支出140.00', 25, 1, '2018-04-26 21:08:20', 0);
INSERT INTO `orders` VALUES (97, 25, 1, 1400.00, '黄哥帅666通过积分收入1400.00', 2, 1, '2018-04-26 21:08:35', 0);
INSERT INTO `orders` VALUES (98, 2, -1, 1235934.00, '44通过积分支出1400.00', 25, 1, '2018-04-26 21:08:35', 0);
INSERT INTO `orders` VALUES (99, 25, -1, 1400.00, '黄哥帅666通过积分支出1400.00', 2, 1, '2018-04-27 13:35:17', 0);
INSERT INTO `orders` VALUES (100, 2, 1, 1234534.00, '44通过积分收入1400.00', 25, 1, '2018-04-27 13:35:17', 0);
INSERT INTO `orders` VALUES (101, 25, 1, 10.00, '黄哥帅666通过充值收入10积分', 3, 2, '2018-04-27 13:36:36', 0);
INSERT INTO `orders` VALUES (102, 3, -1, 1234544.00, '黄成成通过支出支出10积分给用户黄哥帅666充值', 25, 2, '2018-04-27 13:36:36', 0);
INSERT INTO `orders` VALUES (103, 25, 1, 10.00, '黄哥帅666通过充值收入10积分', 3, 2, '2018-04-27 13:36:54', 0);
INSERT INTO `orders` VALUES (104, 3, -1, 1234554.00, '黄成成通过支出支出10积分给用户黄哥帅666充值', 25, 2, '2018-04-27 13:36:54', 0);
INSERT INTO `orders` VALUES (105, 25, 1, 3.00, '黄哥帅666通过充值收入3积分', 3, 2, '2018-04-30 09:14:41', 0);
INSERT INTO `orders` VALUES (106, 3, -1, 1234557.00, '黄成成通过支出支出3积分给用户黄哥帅666充值', 25, 2, '2018-04-30 09:14:41', 0);
INSERT INTO `orders` VALUES (107, 25, -1, 980.00, '黄哥帅666通过积分支出980.00', 2, 1, '2018-04-30 10:49:45', 0);
INSERT INTO `orders` VALUES (108, 2, 1, 1233577.00, '44通过积分收入980.00', 25, 1, '2018-04-30 10:49:45', 0);
INSERT INTO `orders` VALUES (109, 25, -1, 840.00, '黄哥帅666通过积分支出840.00', 2, 1, '2018-04-30 11:02:47', 0);
INSERT INTO `orders` VALUES (110, 2, 1, 1232737.00, '44通过积分收入840.00', 25, 1, '2018-04-30 11:02:47', 0);
INSERT INTO `orders` VALUES (111, 25, -1, 700.00, '黄哥帅666通过积分支出700.00', 2, 1, '2018-04-30 20:49:51', 0);
INSERT INTO `orders` VALUES (112, 2, 1, 1232037.00, '44通过积分收入700.00', 25, 1, '2018-04-30 20:49:51', 0);
INSERT INTO `orders` VALUES (113, 25, -1, 140.00, '黄哥帅666通过积分支出140.00', 2, 1, '2018-04-30 21:52:18', 0);
INSERT INTO `orders` VALUES (114, 2, 1, 1231897.00, '44通过积分收入140.00', 25, 1, '2018-04-30 21:52:18', 0);
INSERT INTO `orders` VALUES (115, 25, -1, 1120.00, '黄哥帅666通过积分支出1120.00', 2, 1, '2018-05-01 00:21:13', 0);
INSERT INTO `orders` VALUES (116, 2, 1, 1230777.00, '44通过积分收入1120.00', 25, 1, '2018-05-01 00:21:13', 0);
INSERT INTO `orders` VALUES (117, 25, -1, 1260.00, '黄哥帅666通过积分支出1260.00', 2, 1, '2018-05-01 00:21:37', 0);
INSERT INTO `orders` VALUES (118, 2, 1, 1229517.00, '44通过积分收入1260.00', 25, 1, '2018-05-01 00:21:37', 0);
INSERT INTO `orders` VALUES (119, 25, -1, 1260.00, '黄哥帅666通过积分支出1260.00', 2, 1, '2018-05-01 00:21:48', 0);
INSERT INTO `orders` VALUES (120, 2, 1, 1228257.00, '44通过积分收入1260.00', 25, 1, '2018-05-01 00:21:48', 0);
INSERT INTO `orders` VALUES (121, 25, -1, 540.00, '黄哥帅666通过积分支出540', 25, 1, '2018-05-01 11:12:08', 0);
INSERT INTO `orders` VALUES (122, 25, 1, 1227717.00, '黄哥帅666通过积分收入540', 25, 1, '2018-05-01 11:12:08', 0);
INSERT INTO `orders` VALUES (123, 25, -1, 720.00, '黄哥帅666通过积分支出720', 25, 1, '2018-05-01 11:36:11', 0);
INSERT INTO `orders` VALUES (124, 25, 1, 1228077.00, '黄哥帅666通过积分收入720', 25, 1, '2018-05-01 11:36:11', 0);
INSERT INTO `orders` VALUES (125, 25, -1, 720.00, '黄哥帅666通过积分支出720', 25, 1, '2018-05-01 11:36:32', 0);
INSERT INTO `orders` VALUES (126, 25, 1, 1228797.00, '黄哥帅666通过积分收入720', 25, 1, '2018-05-01 11:36:32', 0);
INSERT INTO `orders` VALUES (127, 25, -1, 540.00, '黄哥帅666通过积分支出540', 25, 1, '2018-05-01 11:39:51', 0);
INSERT INTO `orders` VALUES (128, 25, 1, 1229697.00, '黄哥帅666通过积分收入540', 25, 1, '2018-05-01 11:39:51', 0);
INSERT INTO `orders` VALUES (129, 25, -1, 180.00, '黄哥帅666通过积分支出180', 25, 1, '2018-05-01 12:45:50', 0);
INSERT INTO `orders` VALUES (130, 25, 1, 180.00, '黄哥帅666通过积分收入180', 25, 1, '2018-05-01 12:45:50', 0);
INSERT INTO `orders` VALUES (131, 25, -1, 180.00, '黄哥帅666通过积分支出180', 25, 1, '2018-05-01 14:06:51', 0);
INSERT INTO `orders` VALUES (132, 25, 1, 180.00, '黄哥帅666通过积分收入180', 25, 1, '2018-05-01 14:06:51', 0);
INSERT INTO `orders` VALUES (133, 25, -1, 1260.00, '黄哥帅666通过积分支出1260', 25, 1, '2018-05-01 14:07:14', 0);
INSERT INTO `orders` VALUES (134, 25, 1, 1260.00, '黄哥帅666通过积分收入1260', 25, 1, '2018-05-01 14:07:14', 0);
INSERT INTO `orders` VALUES (135, 25, -1, 360.00, '黄哥帅666通过积分支出360', 25, 1, '2018-05-01 14:13:37', 0);
INSERT INTO `orders` VALUES (136, 25, 1, 360.00, '黄哥帅666通过积分收入360', 25, 1, '2018-05-01 14:13:37', 0);
INSERT INTO `orders` VALUES (137, 25, -1, 360.00, '黄哥帅666通过积分支出360', 25, 1, '2018-05-01 14:16:41', 0);
INSERT INTO `orders` VALUES (138, 25, 1, 360.00, '黄哥帅666通过积分收入360', 25, 1, '2018-05-01 14:16:41', 0);
INSERT INTO `orders` VALUES (139, 25, -1, 720.00, '黄哥帅666通过积分支出720', 25, 1, '2018-05-01 14:20:52', 0);
INSERT INTO `orders` VALUES (140, 25, 1, 720.00, '黄哥帅666通过积分收入720', 25, 1, '2018-05-01 14:20:52', 0);
INSERT INTO `orders` VALUES (141, 25, -1, 0.00, '黄哥帅666通过积分支出0', 25, 1, '2018-05-01 14:24:32', 0);
INSERT INTO `orders` VALUES (142, 25, 1, 0.00, '黄哥帅666通过积分收入0', 25, 1, '2018-05-01 14:24:32', 0);
INSERT INTO `orders` VALUES (143, 25, -1, 180.00, '黄哥帅666通过积分支出180', 25, 1, '2018-05-01 14:29:20', 0);
INSERT INTO `orders` VALUES (144, 25, 1, 180.00, '黄哥帅666通过积分收入180', 25, 1, '2018-05-01 14:29:20', 0);
INSERT INTO `orders` VALUES (145, 25, -1, 180.00, '黄哥帅666通过积分支出180', 25, 1, '2018-05-01 14:32:22', 0);
INSERT INTO `orders` VALUES (146, 25, 1, 180.00, '黄哥帅666通过积分收入180', 25, 1, '2018-05-01 14:32:22', 0);
INSERT INTO `orders` VALUES (147, 25, -1, 180.00, '黄哥帅666通过积分支出180', 25, 1, '2018-05-01 14:34:21', 0);
INSERT INTO `orders` VALUES (148, 25, 1, 180.00, '黄哥帅666通过积分收入180', 25, 1, '2018-05-01 14:34:21', 0);
INSERT INTO `orders` VALUES (149, 25, -1, 180.00, '黄哥帅666通过积分支出180', 25, 1, '2018-05-01 14:36:09', 0);
INSERT INTO `orders` VALUES (150, 25, 1, 180.00, '黄哥帅666通过积分收入180', 25, 1, '2018-05-01 14:36:10', 0);
INSERT INTO `orders` VALUES (151, 25, -1, 540.00, '黄哥帅666通过积分支出540.00', 25, 1, '2018-05-01 14:56:04', 0);
INSERT INTO `orders` VALUES (152, 25, 1, 540.00, '黄哥帅666通过积分收入540.00', 25, 1, '2018-05-01 14:56:04', 0);
INSERT INTO `orders` VALUES (153, 25, -1, 360.00, '黄哥帅666通过积分支出360', 25, 1, '2018-05-01 14:57:15', 0);
INSERT INTO `orders` VALUES (154, 25, 1, 360.00, '黄哥帅666通过积分收入360', 25, 1, '2018-05-01 14:57:15', 0);
INSERT INTO `orders` VALUES (155, 25, -1, 360.00, '黄哥帅666通过积分支出360', 25, 1, '2018-05-01 15:03:01', 0);
INSERT INTO `orders` VALUES (156, 25, 1, 360.00, '黄哥帅666通过积分收入360', 25, 1, '2018-05-01 15:03:01', 0);
INSERT INTO `orders` VALUES (157, 25, -1, 540.00, '黄哥帅666通过积分支出540', 25, 1, '2018-05-01 15:06:48', 0);
INSERT INTO `orders` VALUES (158, 25, 1, 540.00, '黄哥帅666通过积分收入540', 25, 1, '2018-05-01 15:06:48', 0);
INSERT INTO `orders` VALUES (159, 25, -1, 360.00, '黄哥帅666通过积分支出360', 25, 1, '2018-05-01 15:09:34', 0);
INSERT INTO `orders` VALUES (160, 25, 1, 360.00, '黄哥帅666通过积分收入360', 25, 1, '2018-05-01 15:09:34', 0);

-- ----------------------------
-- Table structure for participate_activities_user
-- ----------------------------
DROP TABLE IF EXISTS `participate_activities_user`;
CREATE TABLE `participate_activities_user`  (
  `participate_activities_id_user` int(11) NOT NULL AUTO_INCREMENT COMMENT '参加用户活动编号',
  `userid` int(11) DEFAULT NULL COMMENT '用户编号',
  `user_custom_activity_id` int(11) DEFAULT NULL COMMENT '用户活动编号',
  `totalnum` int(11) DEFAULT NULL COMMENT '参加人数',
  `payment_money` decimal(65, 2) DEFAULT 0.00 COMMENT '支付金额',
  `payment_state` int(255) DEFAULT 0 COMMENT '用户支付状态 0未支付 1已支付',
  `evaluate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评价',
  `participate_state` int(255) DEFAULT 0 COMMENT '参加状态 0未参加 1已参加',
  `time` datetime(0) DEFAULT NULL COMMENT '下单时间',
  `deletestate` int(255) DEFAULT 0 COMMENT '删除状态0未删除1已删除',
  `ordertime` datetime(0) DEFAULT NULL COMMENT '支付时间',
  PRIMARY KEY (`participate_activities_id_user`) USING BTREE,
  INDEX `userid`(`userid`) USING BTREE,
  INDEX `user_custom_activity_id`(`user_custom_activity_id`) USING BTREE,
  CONSTRAINT `participate_activities_user_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `participate_activities_user_ibfk_2` FOREIGN KEY (`user_custom_activity_id`) REFERENCES `user_custom_activity` (`user_custom_activity_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of participate_activities_user
-- ----------------------------
INSERT INTO `participate_activities_user` VALUES (4, 25, 1, 3, 540.00, 1, NULL, 0, '2018-05-01 11:11:44', 0, '2018-05-01 14:56:04');
INSERT INTO `participate_activities_user` VALUES (5, 25, 1, 3, 540.00, 1, NULL, 0, '2018-05-01 11:12:05', 0, '2018-05-01 11:12:08');
INSERT INTO `participate_activities_user` VALUES (6, 25, 1, 4, 720.00, 1, NULL, 0, '2018-05-01 11:36:07', 0, '2018-05-01 11:36:11');
INSERT INTO `participate_activities_user` VALUES (7, 25, 1, 4, 720.00, 1, NULL, 0, '2018-05-01 11:36:29', 0, '2018-05-01 11:36:32');
INSERT INTO `participate_activities_user` VALUES (8, 25, 1, 3, 540.00, 1, NULL, 0, '2018-05-01 11:39:47', 0, '2018-05-01 11:39:51');
INSERT INTO `participate_activities_user` VALUES (9, 25, 1, 1, 180.00, 0, NULL, 0, '2018-05-01 12:45:36', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (10, 25, 1, 1, 180.00, 0, NULL, 0, '2018-05-01 12:45:42', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (11, 25, 1, 1, 180.00, 1, NULL, 0, '2018-05-01 12:45:47', 0, '2018-05-01 12:45:50');
INSERT INTO `participate_activities_user` VALUES (12, 25, 1, 1, 180.00, 0, NULL, 0, '2018-05-01 14:06:15', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (13, 25, 1, 1, 180.00, 0, NULL, 0, '2018-05-01 14:06:20', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (14, 25, 1, 1, 180.00, 1, NULL, 0, '2018-05-01 14:06:46', 0, '2018-05-01 14:06:51');
INSERT INTO `participate_activities_user` VALUES (15, 25, 1, 7, 1260.00, 1, NULL, 0, '2018-05-01 14:07:11', 0, '2018-05-01 14:07:14');
INSERT INTO `participate_activities_user` VALUES (16, 25, 1, 2, 360.00, 1, NULL, 0, '2018-05-01 14:13:34', 0, '2018-05-01 14:13:37');
INSERT INTO `participate_activities_user` VALUES (17, 25, 1, 2, 360.00, 0, NULL, 0, '2018-05-01 14:13:41', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (18, 25, 1, 2, 360.00, 1, NULL, 0, '2018-05-01 14:16:39', 0, '2018-05-01 14:16:41');
INSERT INTO `participate_activities_user` VALUES (19, 25, 1, 4, 720.00, 1, NULL, 0, '2018-05-01 14:20:49', 0, '2018-05-01 14:20:52');
INSERT INTO `participate_activities_user` VALUES (20, 25, 1, 4, 720.00, 0, NULL, 0, '2018-05-01 14:21:59', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (21, 25, 1, 4, 720.00, 0, NULL, 0, '2018-05-01 14:22:41', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (22, 25, 1, 0, 0.00, 1, NULL, 0, '2018-05-01 14:24:29', 0, '2018-05-01 14:24:32');
INSERT INTO `participate_activities_user` VALUES (23, 25, 1, 1, 180.00, 1, NULL, 0, '2018-05-01 14:29:16', 0, '2018-05-01 14:29:20');
INSERT INTO `participate_activities_user` VALUES (24, 25, 1, 1, 180.00, 0, NULL, 0, '2018-05-01 14:30:03', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (25, 25, 1, 1, 180.00, 1, NULL, 0, '2018-05-01 14:32:20', 0, '2018-05-01 14:32:22');
INSERT INTO `participate_activities_user` VALUES (26, 25, 1, 1, 180.00, 0, NULL, 0, '2018-05-01 14:32:24', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (27, 25, 1, 1, 180.00, 1, NULL, 0, '2018-05-01 14:34:18', 0, '2018-05-01 14:34:21');
INSERT INTO `participate_activities_user` VALUES (28, 25, 1, 1, 180.00, 1, NULL, 0, '2018-05-01 14:36:07', 0, '2018-05-01 14:36:10');
INSERT INTO `participate_activities_user` VALUES (29, 25, 1, 2, 360.00, 1, NULL, 0, '2018-05-01 14:57:12', 0, '2018-05-01 14:57:15');
INSERT INTO `participate_activities_user` VALUES (30, 25, 1, 2, 360.00, 0, NULL, 0, '2018-05-01 14:57:16', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (31, 25, 1, 2, 360.00, 1, NULL, 0, '2018-05-01 15:02:57', 0, '2018-05-01 15:03:01');
INSERT INTO `participate_activities_user` VALUES (32, 25, 1, 2, 360.00, 0, NULL, 0, '2018-05-01 15:03:04', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (33, 25, 1, 2, 360.00, 0, NULL, 0, '2018-05-01 15:03:09', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (34, 25, 1, 3, 540.00, 1, NULL, 0, '2018-05-01 15:06:45', 0, '2018-05-01 15:06:48');
INSERT INTO `participate_activities_user` VALUES (35, 25, 1, 3, 540.00, 0, NULL, 0, '2018-05-01 15:06:51', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (36, 25, 1, 3, 540.00, 0, NULL, 0, '2018-05-01 15:06:55', 0, NULL);
INSERT INTO `participate_activities_user` VALUES (37, 25, 1, 2, 360.00, 1, NULL, 0, '2018-05-01 15:09:31', 0, '2018-05-01 15:09:34');

-- ----------------------------
-- Table structure for participate_venues_activitiey
-- ----------------------------
DROP TABLE IF EXISTS `participate_venues_activitiey`;
CREATE TABLE `participate_venues_activitiey`  (
  `participate_venues_activiey_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '报名场馆编号',
  `userid` int(11) DEFAULT NULL COMMENT '用户编号',
  `venuesid` int(11) DEFAULT NULL COMMENT '场馆编号',
  `venues_allocation_id` int(11) DEFAULT NULL COMMENT '场馆配置编号',
  `enlist_num` int(11) DEFAULT NULL COMMENT '报名人数',
  `payment_money` decimal(62, 2) DEFAULT 0.00 COMMENT '支付金额',
  `payment_state` int(255) DEFAULT 0 COMMENT '支付状态  0未支付 1已支付',
  `user_state` int(255) DEFAULT 0 COMMENT '用户参加状态 0未参加 1已参加',
  `evaluate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评价',
  `deletestate` int(255) DEFAULT 0 COMMENT '删除状态0未删除1已删除',
  `createtime` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `ordertime` datetime(0) DEFAULT NULL COMMENT '下单时间',
  `finishtime` datetime(0) DEFAULT NULL COMMENT '完成时间',
  PRIMARY KEY (`participate_venues_activiey_id`) USING BTREE,
  INDEX `userid`(`userid`) USING BTREE,
  INDEX `venuesid`(`venuesid`) USING BTREE,
  INDEX `venues_allocation_id`(`venues_allocation_id`) USING BTREE,
  CONSTRAINT `participate_venues_activitiey_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `participate_venues_activitiey_ibfk_2` FOREIGN KEY (`venuesid`) REFERENCES `venues` (`venuesid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `participate_venues_activitiey_ibfk_3` FOREIGN KEY (`venues_allocation_id`) REFERENCES `venues_allocation` (`venues_allocation_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of participate_venues_activitiey
-- ----------------------------
INSERT INTO `participate_venues_activitiey` VALUES (9, 25, 1, 3, 1, 140.00, 1, 1, '3.3333333\n范金金稀少都到现在又退回答问题是什么原因也许多久了很多很多很多很多很多很多很多很多很多很多很多很多很多地方', 0, '2018-04-25 13:46:31', '2018-04-25 23:21:59', '2018-04-26 00:24:08');
INSERT INTO `participate_venues_activitiey` VALUES (10, 25, 1, 1, 10, 1200.00, 1, 1, NULL, 0, '2018-04-25 13:47:42', '2018-04-25 23:22:02', '2018-04-26 14:47:58');
INSERT INTO `participate_venues_activitiey` VALUES (11, 25, 1, 2, 10, 1400.00, 1, 1, NULL, 0, '2018-04-25 13:50:35', '2018-04-25 23:22:05', '2018-04-26 14:48:56');
INSERT INTO `participate_venues_activitiey` VALUES (15, 25, 1, 3, 1, 140.00, 1, 1, NULL, 0, '2018-04-25 20:49:12', '2018-04-25 23:22:07', '2018-04-26 14:49:02');
INSERT INTO `participate_venues_activitiey` VALUES (16, 25, 1, 3, 1, 140.00, 1, 1, NULL, 0, '2018-04-25 21:01:08', '2018-04-25 21:01:10', '2018-04-26 14:49:07');
INSERT INTO `participate_venues_activitiey` VALUES (17, 25, 1, 3, 1, 140.00, 1, 1, NULL, 0, '2018-04-25 21:01:24', '2018-04-25 21:01:27', '2018-04-26 14:49:12');
INSERT INTO `participate_venues_activitiey` VALUES (18, 25, 6, 10, 20, 20.00, 1, 1, NULL, 0, '2018-04-26 09:30:36', '2018-04-26 09:30:37', '2018-04-26 14:49:16');
INSERT INTO `participate_venues_activitiey` VALUES (19, 25, 1, 3, 1, 140.00, 1, -1, NULL, 0, '2018-04-26 09:34:11', '2018-04-26 15:31:56', '2018-04-26 21:08:20');
INSERT INTO `participate_venues_activitiey` VALUES (20, 25, 1, 3, 10, 1400.00, 1, 1, NULL, 0, '2018-04-26 09:39:13', '2018-04-26 15:36:38', '2018-04-28 22:12:23');
INSERT INTO `participate_venues_activitiey` VALUES (21, 25, 1, 3, 10, 1400.00, 1, 0, NULL, 0, '2018-04-26 09:42:41', '2018-04-26 21:00:32', NULL);
INSERT INTO `participate_venues_activitiey` VALUES (22, 25, 1, 3, 10, 1400.00, 1, -1, NULL, 0, '2018-04-26 09:45:04', '2018-04-26 20:07:45', '2018-04-26 21:08:35');
INSERT INTO `participate_venues_activitiey` VALUES (23, 25, 1, 3, 10, 1400.00, 1, 1, NULL, 0, '2018-04-26 09:49:15', '2018-04-26 09:49:17', '2018-04-26 14:49:21');
INSERT INTO `participate_venues_activitiey` VALUES (31, 25, 1, 3, 10, 1400.00, 1, 1, NULL, 0, '2018-04-27 13:35:15', '2018-04-27 13:35:17', '2018-04-28 22:25:17');
INSERT INTO `participate_venues_activitiey` VALUES (32, 25, 1, 3, 1, 140.00, 1, 0, NULL, 0, '2018-04-30 21:52:05', '2018-04-30 21:52:18', NULL);
...
CREATE TABLE `provinces`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `provinceid` int(11) DEFAULT NULL COMMENT '省编号',
...
CREATE TABLE `user`  (
  ...
  `user_nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户昵称',
  `user_truename` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户真实姓名',
  `user_email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户邮箱',
  `user_password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'root' COMMENT '用户密码',
  `user_paypassword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户支付密码',
  `user_balance` decimal(65, 2) DEFAULT 0.00 COMMENT '用户积分',
  `user_resign_date` datetime(0) DEFAULT NULL COMMENT '用户注册日期',
  `user_login_date` datetime(0) DEFAULT NULL COMMENT '用户登陆时间',
  `user_login_count` int(255) DEFAULT 0 COMMENT '用户登入次数',
  `user_state` int(255) NOT NULL DEFAULT 0 COMMENT '用户状态0 可用1禁用',
  `user_authority` int(255) NOT NULL DEFAULT 3 COMMENT '用户权限',
  `user_drive` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户设备',
  `deletestate` int(255) DEFAULT 0 COMMENT '删除状态0未删除1已删除',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户电话',
  PRIMARY KEY (`userid`) USING BTREE,
  INDEX `user_authority`(`user_authority`) USING BTREE,
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`user_authority`) REFERENCES `authority` (`authority_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (2, '44', '44', '123@qq.com', '81DC9BDB52D04DC20036DBD8313ED055', NULL, 21560.00, '2018-03-31 17:23:58', '2018-04-12 16:28:59', 9, 0, 2, NULL, 0, '15152045594');
INSERT INTO `user` VALUES (3, 'huangge', '黄成成', 'admin@bowling.com', '81DC9BDB52D04DC20036DBD8313ED055', NULL, -23.00, '2018-03-31 17:24:53', '2018-05-01 14:09:31', 296, 0, 1, NULL, 0, '15152040097');
INSERT INTO `user` VALUES (4, 'hah', 'asd', '23458892@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-03-31 17:28:13', NULL, 0, 0, 3, NULL, 1, '15895259244 \r\n');
INSERT INTO `user` VALUES (5, '234', '234', '12333@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 213.00, '2018-03-31 21:55:46', NULL, 0, 0, 3, NULL, 1, '15895251019 \r\n');
INSERT INTO `user` VALUES (6, '34', '44', '1233w3@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-03-31 21:56:35', NULL, 0, 0, 3, NULL, 0, '15152045578 \r\n');
INSERT INTO `user` VALUES (7, 'werrr', 'rrr', '1123@qw.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-01 10:43:26', NULL, 0, 0, 3, NULL, 0, '15895259371 \r\n');
INSERT INTO `user` VALUES (8, 'wer', 'wer', '12@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-01 13:21:35', NULL, 0, 0, 3, NULL, 0, '15895253782 \r\n');
INSERT INTO `user` VALUES (9, 'hhe', 'ert111', '121@qq.com', '4E8F794089B6B4EF55CD0399DCA1433C', NULL, 0.00, '2018-04-01 13:22:04', NULL, 0, 0, 3, NULL, 0, '15152047652 \r\n');
INSERT INTO `user` VALUES (10, 'zzp', '章志鹏', 'zzpem123@163.com', '63A9F0EA7BB98050796B649E85481845', NULL, 66666866666666.00, '2018-04-01 15:16:53', NULL, 0, 0, 3, NULL, 0, '15895256830 \r\n');
INSERT INTO `user` VALUES (11, 'er', 'er', '24@qq.com', '6512BD43D9CAA6E02C990B0A82652DCA', NULL, 1356.00, '2018-04-01 18:13:51', NULL, 0, 0, 3, NULL, 0, '15895255347 \r\n');
INSERT INTO `user` VALUES (12, '23', '23', '1233311@qq.com', 'C20AD4D76FE97759AA27A0C99BFF6710', NULL, 123.00, '2018-04-02 20:45:16', NULL, 0, 0, 3, NULL, 0, '15152047983 \r\n');
INSERT INTO `user` VALUES (13, '213', '123', '11@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-02 22:55:09', NULL, 0, 0, 3, NULL, 1, '15152044909 \r\n');
INSERT INTO `user` VALUES (14, '12', '12', '1234567899@qq.com', 'E10ADC3949BA59ABBE56E057F20F883E', NULL, 0.00, '2018-04-03 09:16:12', NULL, 0, 1, 3, NULL, 0, '15895254121 \r\n');
INSERT INTO `user` VALUES (15, 'nihao', '孙立', '123@qq.cm', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-04 09:51:35', NULL, 0, 0, 2, NULL, 0, '15895256875');
INSERT INTO `user` VALUES (16, '12', '12', '1@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-04 09:59:58', NULL, 0, 0, 2, NULL, 0, '15152046571 \r\n');
INSERT INTO `user` VALUES (17, '123', '123', '12233444@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-06 15:19:45', NULL, 0, 0, 3, NULL, 1, '15895256271 \r\n');
INSERT INTO `user` VALUES (18, 'vip', 'vip', '562679864@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 1000000000.00, '2018-04-06 15:43:06', NULL, 0, 0, 3, NULL, 0, '15895258259 \r\n');
INSERT INTO `user` VALUES (19, '想赢别就别喊疼', '王洪昌', '1042691260@qq.cm', '63A9F0EA7BB98050796B649E85481845', NULL, 8000000000000000.00, '2018-04-06 16:36:09', NULL, 0, 0, 2, NULL, 0, '15895252689 \r\n');
INSERT INTO `user` VALUES (21, '1', '1', '1231@qq.cm', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-09 18:49:13', NULL, 0, 0, 2, NULL, 0, '15152049047 \r\n');
INSERT INTO `user` VALUES (22, NULL, NULL, '1234@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 0.00, '2018-04-12 15:42:41', NULL, 0, 0, 3, NULL, 0, '13067851230');
INSERT INTO `user` VALUES (23, NULL, NULL, 'huang@qq.com', '81DC9BDB52D04DC20036DBD8313ED055', NULL, 0.00, '2018-04-13 16:02:46', '2018-04-14 14:05:13', 44, 0, 3, 'msm8998G8142', 0, '15852153829');
INSERT INTO `user` VALUES (25, '黄哥帅666', '黄哥帅666', '1289342923@qq.com', '81DC9BDB52D04DC20036DBD8313ED055', '81DC9BDB52D04DC20036DBD8313ED055', 1236717.00, '2018-04-14 14:07:12', '2018-05-01 15:09:24', 953, 0, 3, 'msm8998G8142', 0, '15852153827');
INSERT INTO `user` VALUES (26, NULL, NULL, '1w1@qq.com', '202CB962AC59075B964B07152D234B70', NULL, 0.00, '2018-04-14 14:14:24', '2018-04-14 14:16:26', 3, 0, 3, 'msm8998G8142', 0, '15852153823');
INSERT INTO `user` VALUES (27, '贾国飚', '贾国飚', '1165466294@qq.com', '63A9F0EA7BB98050796B649E85481845', NULL, 100999999999998.00, '2018-04-15 14:35:53', NULL, 0, 0, 3, NULL, 0, '18552820094');
...
CREATE TABLE `user_bank`  (
  ...
  `user_bank_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户银行卡号',
  `addtime` datetime(0) DEFAULT NULL COMMENT '添加时间',
  `userbankid` int(11) NOT NULL AUTO_INCREMENT,
  `cause` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '银行卡详细信息',
  PRIMARY KEY (`userbankid`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `user_bank_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_bank
-- ----------------------------
INSERT INTO `user_bank` VALUES (25, '6217001250011075961', '2018-04-23 16:46:53', 1, '银行:建设银行\n银行id:105\n银行卡类型:储蓄卡');
INSERT INTO `user_bank` VALUES (25, '6223050012502483', '2018-04-23 16:47:47', 2, '银行:南京银行\n银行id:424\n银行卡类型:储蓄卡');

-- ----------------------------
-- Table structure for user_custom_activity
-- ----------------------------
DROP TABLE IF EXISTS `user_custom_activity`;
CREATE TABLE `user_custom_activity`  (
  `user_custom_activity_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '用户自定义活动id',
  `venuesid` int(11) DEFAULT NULL COMMENT '场馆编号',
  `userid` int(11) DEFAULT NULL COMMENT '发起人编号',
  `venues_allocation_id` int(11) DEFAULT NULL COMMENT '场馆配置编号',
  `activities_setting_time` datetime(0) DEFAULT NULL COMMENT '活动建立时间',
  `activities_start_time` datetime(0) DEFAULT NULL COMMENT '活动开始时间',
  `activities_stop_time` datetime(0) DEFAULT NULL COMMENT '活动结束时间',
  `enlist_start_time` datetime(0) DEFAULT NULL COMMENT '报名开始时间',
  `enlist_stop_time` datetime(0) DEFAULT NULL COMMENT '报名结束时间',
  `total` int(11) DEFAULT NULL COMMENT '总人数',
  `enlistnum` int(11) DEFAULT 0 COMMENT '报名人数',
  `paymentmoney` decimal(65, 2) DEFAULT 0.00 COMMENT '缴费金额',
  `auditing` int(255) DEFAULT 0 COMMENT '审核 0未通过 1通过',
  `detailinfo` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '活动描述',
  `cause` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '审核原因',
  `pay_state` int(255) DEFAULT 0 COMMENT '是否支付 0未支付1已支付',
  `deletestate` int(255) DEFAULT 0 COMMENT '删除状态0未删除1已删除',
  `createtime` datetime(0) DEFAULT NULL COMMENT '审核时间',
  `imageurl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片路径',
  `activityname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '活动名称',
  `userpay` decimal(65, 0) DEFAULT NULL COMMENT '用户缴费',
  PRIMARY KEY (`user_custom_activity_id`) USING BTREE,
  INDEX `userid`(`userid`) USING BTREE,
  INDEX `venuesid`(`venuesid`) USING BTREE,
  INDEX `venues_allocation_id`(`venues_allocation_id`) USING BTREE,
  CONSTRAINT `user_custom_activity_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_custom_activity_ibfk_2` FOREIGN KEY (`venuesid`) REFERENCES `venues` (`venuesid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_custom_activity_ibfk_3` FOREIGN KEY (`venues_allocation_id`) REFERENCES `venues_allocation` (`venues_allocation_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_custom_activity
-- ----------------------------
INSERT INTO `user_custom_activity` VALUES (1, 1, 25, 3, '2018-04-30 11:04:01', '2018-05-06 09:00:00', '2018-05-06 17:58:00', '2018-05-01 08:58:00', '2018-05-02 21:58:00', 37, 36, 1120.00, 1, 'GB版本', 'henhao', 1, 0, '2018-05-01 00:23:13', '/upload/usercustomeractivity/1/11859a71785254f89a598b8f7b4093801VenuesPicture.png', '与哈哈', 180);
INSERT INTO `user_custom_activity` VALUES (2, 1, 25, 3, '2018-04-30 11:04:04', '2018-05-09 09:01:00', '2018-05-09 18:02:00', '2018-05-01 22:01:00', '2018-05-08 22:01:00', 12, 0, 1260.00, 0, '不会后悔', NULL, 1, 0, NULL, NULL, '太好喝', 69);
INSERT INTO `user_custom_activity` VALUES (3, 1, 25, 3, '2018-04-30 11:04:09', '2018-05-11 09:15:00', '2018-05-11 18:15:00', '2018-05-03 22:14:00', '2018-05-09 22:15:00', 13, 0, 1260.00, 0, 'g HBV BBB HN', NULL, 1, 0, NULL, '/upload/usercustomeractivity/3/3c971417e285542deb2a9f4c7fdd90792VenuesPicture.JPG', '法规和环境', 566);
INSERT INTO `user_custom_activity` VALUES (4, 1, 25, 3, '2018-04-30 11:04:11', '2018-05-10 09:53:00', '2018-05-10 17:53:00', '2018-05-01 08:52:00', '2018-05-05 09:52:00', 12, 0, 1120.00, 0, '估计', NULL, 0, 0, NULL, '/upload/usercustomeractivity/4/44e68025176a94288af7fe4ab371edc61VenuesPicture.png', '让他', 2);
INSERT INTO `user_custom_activity` VALUES (5, 1, 25, 3, '2018-04-30 10:44:22', '2018-05-11 10:43:00', '2018-05-11 17:43:00', '2018-05-02 10:43:00', '2018-05-03 10:43:00', 12, 0, 980.00, 0, 'FG VB', NULL, 0, 0, NULL, '/upload/usercustomeractivity/5/59226ed811d2e43ca9f4a63ac8bf806aeVenuesPicture.JPG', '非黑即白', 55);
INSERT INTO `user_custom_activity` VALUES (6, 1, 25, 3, '2018-04-30 10:47:42', '2018-05-19 10:47:00', '2018-05-19 18:25:00', '2018-05-03 10:47:00', '2018-05-05 10:47:00', 568, 0, 980.00, 0, '富豪榜', NULL, 0, 0, NULL, '/upload/usercustomeractivity/6/6415734c425f5411bbae33546b7544b8eVenuesPicture.jpg', '土豪', 12);
INSERT INTO `user_custom_activity` VALUES (7, 1, 25, 3, '2018-04-30 10:49:23', '2018-05-12 10:49:00', '2018-05-12 18:25:00', '2018-05-05 10:48:00', '2018-05-12 10:48:00', 58, 0, 980.00, 0, '打个电话借古讽今看看那你就', NULL, 0, 0, NULL, '/upload/usercustomeractivity/7/707e42266429a470c8e3430227d7af72bVenuesPicture.jpg', '途径', 669);
INSERT INTO `user_custom_activity` VALUES (8, 1, 25, 3, '2018-04-30 10:49:41', '2018-05-12 10:49:00', '2018-05-12 18:25:00', '2018-05-05 10:48:00', '2018-05-12 10:48:00', 58, 0, 980.00, 1, '打个电话借古讽今看看那你就', '好', 1, 0, '2018-04-30 16:54:27', '/upload/usercustomeractivity/8/817ede829a98348828fddcad9c2293464VenuesPicture.jpg', '途径', 669);
INSERT INTO `user_custom_activity` VALUES (9, 1, 25, 3, '2018-04-30 11:02:45', '2018-05-30 11:02:00', '2018-05-30 17:02:00', '2018-05-11 11:02:00', '2018-05-25 11:02:00', 25, 0, 840.00, 1, '发vb比较可靠', '该活动通过审核', 1, 0, '2018-04-30 16:53:16', '/upload/usercustomeractivity/9/9a9c2448b376b453ea844a20a1070441fVenuesPicture.jpg', '与货币', 88);
INSERT INTO `user_custom_activity` VALUES (11, 1, 25, 3, '2018-04-30 20:49:43', '2018-05-31 12:46:00', '2018-05-31 18:25:00', '2018-05-10 20:46:00', '2018-05-25 20:46:00', 59, 0, 700.00, 1, '徐bbb你', 'keyi', 1, 0, '2018-04-30 22:51:13', '/upload/usercustomeractivity/11/1122ff0e42b6ac451e8b82d1fab24cf1f4VenuesPicture.jpg', '干几年', 258);
...
CREATE TABLE `venues`  (
  `venuesid` int(11) NOT NULL AUTO_INCREMENT COMMENT '场馆编号',
  `venues_user_charge` int(255) DEFAULT NULL COMMENT '场馆负责人',
  `venues_provice` int(255) NOT NULL COMMENT '场馆所在省',
  `venues_city` int(255) DEFAULT NULL COMMENT '场馆所在市',
  `venues_areas` int(255) DEFAULT NULL COMMENT '场馆所在县',
  `venues_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '场馆具体地址',
  `venues_longitude` decimal(15, 10) DEFAULT NULL COMMENT '场馆经度',
  `venues_latitude` decimal(15, 10) DEFAULT NULL COMMENT '场馆纬度',
  `open_time` time(0) DEFAULT NULL COMMENT '开馆时间',
  `close_time` time(0) DEFAULT NULL COMMENT '闭馆时间',
  `venues_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '场馆名称',
  `deletestate` int(255) DEFAULT 1 COMMENT '删除状态0未删除1已删除',
  `cause` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '无' COMMENT '审核原因',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '场馆联系方式',
  `brief` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '场馆简介',
  `imageurl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片路径',
  PRIMARY KEY (`venuesid`) USING BTREE,
  INDEX `venues_provice`(`venues_provice`) USING BTREE,
  INDEX `venues_city`(`venues_city`) USING BTREE,
  INDEX `venues_areas`(`venues_areas`) USING BTREE,
  INDEX `venues_user_charge`(`venues_user_charge`) USING BTREE,
  CONSTRAINT `venues_ibfk_2` FOREIGN KEY (`venues_provice`) REFERENCES `provinces` (`provinceid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `venues_ibfk_3` FOREIGN KEY (`venues_city`) REFERENCES `cities` (`cityid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `venues_ibfk_4` FOREIGN KEY (`venues_areas`) REFERENCES `areas` (`areaid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `venues_ibfk_5` FOREIGN KEY (`venues_user_charge`) REFERENCES `user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of venues
-- ----------------------------
INSERT INTO `venues` VALUES (1, 2, 320000, 320300, 320303, '徐州工程学院', 117.3016720000, 34.1933160000, '08:30:00', '18:30:00', '工程学院保龄球', 0, '1', '15152044866', '中兴危机，引来芯片行业震荡\r\n\r\n最近一周来，芯片行业的震荡幅度简直前所未有。\r\n\r\n事情要追溯到几天之前。自从前几天4月16日，美国商务部宣布，由于中兴违反了美国限制向伊朗出售美国技术的制裁条款，因此制裁未来7年将禁止美国公司向中兴通讯销售零部件、商品、软件和技术。从此开始，芯片市场就进入了一波接一波的动荡当中。中国企业芯片自主研发能力薄弱，许多关键技术关键产品受制于人的“缺芯”问题被推倒了聚光灯下。\r\n\r\n而就在昨天，阿里巴巴达摩院表示，其正研发一款神经网络芯片Ali-NPU，该芯片将运用于图像视频分析、机器学习等AI推理（inference）计算。\r\n\r\n阿里达摩院研究员骄旸介绍，Ali-NPU基于阿里机器智能技术实验室等团队在AI领域积累的大量算法模型优势，根据AI算法模型设计微结构以及指令集，以小成本实现大量的AI模型算法运算。按照设计，该芯片的性价比将是目前同类产品的40倍。\r\n\r\n同样在这几天里，根据知情人士消息，近日处在舆论风口浪尖的Facebook也正在组建一个团队来设计自己的芯片业务，以降低对英特尔、高通等芯片制造商的依赖。\r\n\r\n根据Facebook网站上的招聘信息显示，这家社交媒体公司正在聘请专人建立一个“端对端SoC/ASIC，固件和驱动程序开发组织”。这表明，这项工作还处于初级阶段。不过早在2017年10月时，Facebook就已经被报道出正在和英特尔Nervana合作开发AI芯片的消息。\r\n\r\n阿里巴巴的AI芯片梦\r\n\r\n在BAT三大巨头当中，阿里算是在芯片、AI芯片等话题上投入最多的一项，不仅一直以来都在加码AI和AI芯片，在投资领域也持续动作不断。\r\n\r\n除了2016年1月入股中天微成为其第一大股东之外，近两年来阿里在AI及AI芯片方面的投资还包括：寒武纪、旷视科技、思必驰、小i机器人等等，其中涉及AI在细分垂直领域的诸多应用，包括区块链、边缘计算、新型存储、量子计算等。\r\n\r\n2016年11月，阿里与腾讯一起参与领投了可编程芯片公司Barefoot Networks的2300万美元C轮融资。\r\n\r\n2017年8月，阿里投资了AI芯片公司寒武纪的近1亿美元A轮融资，寒武纪也因为麒麟970而被称为全球第一个成功流片并拥有成熟产品的AI芯片公司。\r\n\r\n2017年11月，阿里集团内的资金又领投了另一家AI芯片公司耐能，相关数据显示，它所需体积可以缩小至主流神经网络芯片的1/40。\r\n\r\n此外，国内科技巨头如百度、阿里、腾讯、科大讯飞等也都陆续进军云AI芯片领域，不过暂时以投资动向居多，其中百度在2017年8月发布了XPU，这是一款256核、基于FPGA的云计算AI芯片。\r\n\r\n结语：芯片市场战火纷飞大老玩家齐齐上阵\r\n\r\n近年来，我国芯片自给率不断提升。但在很多领域，国产芯片还有较大差距。数据显示，2016年中国进口芯片金额高达2300亿美元，花费几乎是排在第二名的原油进口金额的两倍。“缺芯少魂”的问题，再次严峻地摆在人们面前。\r\n\r\n随着巨头玩家的不断入局、创业公司的快速奔跑，以AI芯片为代表的芯片产业，已经逐步战火升级，再加之中兴事件的加速催化，已然成为了一场日益白热化的竞争市场。在可预见的将来，除了动作频频的阿里之外，百度、腾讯也会有所动作。', '/upload/venues/1/1f6d1d3b195f74e83a87a8600b0fb547dVenuesPicture.jpg');
INSERT INTO `venues` VALUES (2, 15, 320000, 320300, 320303, '绿地商务中心', 117.2852680000, 34.2154780000, '08:30:00', '22:30:00', '绿地保龄球馆', 0, '1', '15152044656', '017年，美国宇航局火星项目主管表示，美国宇航局非常关注深空网络，很可能该系统在2020年和2021年超负荷运行，届时会有大量火星太空任务，其中包括：SpaceX、印度、阿联酋、欧洲航天局和美国宇航局的火星探测器。作为回应，利希滕说：“美国宇航局将进行大量升级和改造，来应对通讯超负荷现象，包括与其他国家建立合作关系，以及获得美国摩海德州立大学的技术支持，在必要的时候使用其他机构的天线设备。这些措施将很大程度地减少美国宇航局对于火星通讯拥堵的顾虑和担忧。”\r\n\r\n尽管如此，通讯容量问题并未消除，因此深空网络天线阵列的更新升级正在进行之中。深空网络项目主管桑尼·吉劳克斯（Sonny Giroux）说：“未来需求将远大于可用性。”据悉，目前Peraton公司与喷气推进实验室签订深空网络天线阵列运营的分包合同。近期Peraton公司与美国宇航局共同开发了一个项目，对每个天线装配4个独立的深空接收器，这样可以实现一个天线完成4个天线的工作。太空飞船能同时向地球拨打电话，同时软件可以分类数据流。这意味着地球轨道近30个太空飞船试着与地球建立通讯时能分类数据，同时不会接收到一些熟知的乐曲。\r\n\r\n甚至还有更好的解决办法，美国宇航局正在测试一种叫做“中断容错网络”的星际互联网络，它基本上是一种中继站系统，能够中转信息数据，作为一个缓冲，避免信息延迟或者出现故障，未来太空飞船可能拥有自己的小型中继站。目前，美国宇航局正在做这一方面的积极尝试，计划今年5月份发射的火星任务建立小规模中继站，届时将携载两颗中继卫星，发送飞船下降和着陆的实况信息。\r\n\r\n预计“洞察号火星登陆器（InSight Mars lander）”最早于今年5月份发射，11月26日登陆火星表面，它将研究火星历史和内部结构。通常情况下，像“洞察号火星登陆器”这样的太空任务准备登陆，它将使用“火星轨道勘测器”或者“火星奥德赛轨道器”作为与地球通讯的中继站。但是这两颗探测器在这段时间里无法提供帮助，因为它们并不处于合适的空间位置，将信息数据直接发送至地球。因此，美国宇航局将部署两颗叫做“火星立方1号（Mars Cube One）”的中继卫星，它们将具有无线电中继作用。“火星立方1号”任务主管、喷气推进实验室工程师安迪·克雷什（Andy Klesh）称，这两颗卫星将能够接收到“洞察火星登陆器”下降时的信息，然后再发送至地面工作人员，整个过程确保一切运行正常。\r\n\r\n人们仅需等待1个小时，就能知道价值10亿美元的太空飞船是否完好。但是没有人希望这样做，同时有更多的权宜信息可能对于航天器安全着陆十分有益（或者理解如果不这样做的话，会有什么问题）。“火星立方1号”卫星长14.4英寸、宽9.5英寸、高4.6英寸（大约是科思科麦片盒大小），比普通卫星小一些，价格相当便宜一些。如果一切顺利，类似的小型、廉价中继器可用于火星或者月球监控任务，在那里轨道飞行器较少，而且经常超负荷工作，需要排列时间，并缺少带宽', '/upload/venues/2/23df74472152e4e5aa96e5ee8629e3ee0VenuesPicture.jpg');
INSERT INTO `venues` VALUES (3, 16, 320000, 320300, 320303, '淮海文博园', 117.2341480000, 34.2147910000, '08:30:00', '21:30:00', '淮海文博园保龄球馆', 0, '1', '15895252214', '虽然目前而言无线电天线仍然是太空通信的支柱，但目前未来发展方向是激光通讯系统。该系统能够编码数据在一束可见光（与无线电波截然相反），之后在太空飞船和地球之间进行传输。聚焦激光操作的波长范围比无线电波短1万倍，意味着激光每秒能载波更多信息。因此，激光数据传送速率是无线电波系统的10-100倍，同时，激光能够在很远的距离保持一定的信号强度。\r\n\r\n据悉，这项技术首次是2013年在月球轨道进行测试，当时月球勘测轨道器在检查月球陨坑和地形结构时，同时接收到了蒙娜丽莎的图像。这次信息传送首次标志着科学家使用激光在太空中发送信息，但是美国宇航局仍需要在更大范围内进行测试。\r\n\r\n“激光通信中继演示任务（Laser Communications Relay Demonstration mission）”将于2019年全面展开，该任务是通过向卫星传送数据。紧随其后的是“普赛克任务（Psyche）”，探测器能够抵达一颗小行星黑色心脏区域，像“洞察号火星登陆器”一样，它能够提供实时勘测信息。普赛克任务的“深空光学通讯实验”将测试一个最新深空光端机和地面数据系统，使用近红外激光在太空和地球之间传送数据。但是预计普赛克探测器最早于2022年发射升空。\r\n\r\n月球勘测分析研究所（LEAG）退休主席、地球化学家克莱夫·尼尔（Clive Neal）称，未来地球和月球之间的通信线路会变得更加繁忙，尤其是如果美国研发其长期计划和备受争议的“月球轨道平台-大门”（简称LOP-G，可实现地月信息传送）。LOP-G将是邻近月球的一个太空栖息基地，同时它是一个电力站和通讯站。同时，地球人造卫星可能拥有独立的通信网络，尤其是如果人类探索者返回地球时，太空通讯将变得尤为重要。\r\n\r\n他还指出，当前许多国家太空机构开始勘测月球，而不是火星，这是美国曾勘测过的星球，未来美国将引领我们再次探索地月系统之外的空间。\r\n\r\n就像所有事情那样，金钱可能决定深空网络的未来发展，以及所有的空间通信。利希滕表示，深空网络的运营商一直忙于处理维护升级该项目的预算需求，深空网络非常稳定，但要持续保持这种状态，需要时刻保持警惕。', '/upload/venues/3/370bfcd44726c4d2bbbb2ce92dab81b98VenuesPicture.jpg');
INSERT INTO `venues` VALUES (4, 15, 320000, 320300, 320303, '西贺花园东厂', 117.2539540000, 34.2485760000, '08:30:00', '19:30:00', '花园保龄球馆', 0, '1', '15152049469 \r\n', '无', '/upload/venues/4/4b5473a81c77048088bfc9080833875ddVenuesPicture.jpg');
INSERT INTO `venues` VALUES (5, 16, 320000, 320300, 320303, '和平大道1号', 117.2237000000, 34.2520000000, '14:30:00', '21:30:00', '和平保龄球场', 0, '1', '15895254143 \r\n', '无', '/upload/venues/5/55e17a605d99644f78c2c09ecd18a6c21VenuesPicture.jpg');
INSERT INTO `venues` VALUES (6, 15, 320000, 320300, 320303, '彭祖园', 117.1873520000, 34.2405010000, '00:00:00', '21:30:00', '和平保龄球场123', 0, '1', '15152043984 \r\n', '无', '/upload/venues/6/61b1767f5a2c741d3a32b4211d838bc2dVenuesPicture.jpg');
INSERT INTO `venues` VALUES (7, 19, 320000, 320500, 320584, '松陵大道', 120.6240540000, 31.1329920000, '08:00:00', '20:30:00', '打日本保龄球馆', 0, 'dadad', '15152046713 \r\n', '无', '/upload/venues/7/7d526643f530b4e10b7bfc9c11de6d141VenuesPicture.jpg');
INSERT INTO `venues` VALUES (8, 19, 320000, 320100, 320111, '孵鹰大厦', 118.6428930000, 32.0367850000, '08:30:00', '16:30:00', '保龄球馆', 0, '无', '13067851230', '无', '/upload/venues/8/87a5afc8118a047da842198bc22fb7dc3VenuesPicture.jpg');
INSERT INTO `venues` VALUES (9, 19, 320000, 320300, 320303, '开明市场', 117.2437430000, 34.2616940000, '08:30:00', '20:30:00', '开明市场保龄球馆', 0, '无', '15650578764', '开明市场保龄球馆', '/upload/venues/9/99edbcad5ceda4681a969c081bf34f2e7VenuesPicture.jpg');
INSERT INTO `venues` VALUES (10, 15, 320000, 320300, 320303, '金龙湖公园', 117.2798120000, 34.2621320000, '08:30:00', '19:30:00', '金龙湖公园保龄球场', 0, '无', '15904567834', '金龙湖公园保龄球场', '/upload/venues/10/106b03e40ce9c042c19265a9f6da35d422VenuesPicture.jpg');
INSERT INTO `venues` VALUES (11, 16, 320000, 320300, 320303, '明珠广场', 117.2515600000, 34.2531670000, '08:30:00', '17:30:00', '明珠广场保龄球场', 0, '无', '13067851238', '明珠广场保龄球场', '/upload/venues/11/11bb7dee85c937435dac8ded568fb5a1ccVenuesPicture.jpg');
INSERT INTO `venues` VALUES (12, 2, 320000, 320300, 320303, '云龙区政府', 117.2510760000, 34.2531640000, '08:30:00', '19:30:00', '云龙区政府保龄球场', 0, '无', '15790879807', '云龙区政府保龄球场', '/upload/venues/12/12c1754e6c37ab42649b742c3869fb77e8VenuesPicture.jpg');
INSERT INTO `venues` VALUES (13, 21, 320000, 320300, 320303, '明富路', 117.2515600000, 34.2531670000, '08:30:00', '23:30:00', '明富路保龄球', 0, '无', '15490875642', '明富路保龄球', '/upload/venues/13/13870d7b1f389a4184a912149798227840VenuesPicture.jpg');

-- ----------------------------
-- Table structure for venues_allocation
-- ----------------------------
DROP TABLE IF EXISTS `venues_allocation`;
CREATE TABLE `venues_allocation`  (
  `venues_allocation_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '场馆配置id',
  `venuesid` int(11) DEFAULT NULL COMMENT '场馆id',
  `venues_configuration` int(255) DEFAULT NULL COMMENT '场馆配置（如贵宾区）',
  `venues_allocation_state` int(255) DEFAULT NULL COMMENT '使用状态',
  `fee_scale` decimal(65, 2) DEFAULT NULL COMMENT '收费标准 单位小时',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '配置说明',
  PRIMARY KEY (`venues_allocation_id`) USING BTREE,
  INDEX `venuesid`(`venuesid`) USING BTREE,
  CONSTRAINT `venues_allocation_ibfk_1` FOREIGN KEY (`venuesid`) REFERENCES `venues` (`venuesid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of venues_allocation
-- ----------------------------
INSERT INTO `venues_allocation` VALUES (1, 7, 1, 1, 1.20, '这是vip');
INSERT INTO `venues_allocation` VALUES (2, 7, 1, 1, 1.00, 'qweqewdddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd');
INSERT INTO `venues_allocation` VALUES (3, 1, 2, 2, 140.00, '这是标准的普通厅');
INSERT INTO `venues_allocation` VALUES (4, 1, 1, 3, 120.00, '这是豪华厅');
INSERT INTO `venues_allocation` VALUES (5, 1, 1, 1, 120.00, 'vip套件');
INSERT INTO `venues_allocation` VALUES (6, 1, 1, 1, 120.00, 'qweqwe231313');
INSERT INTO `venues_allocation` VALUES (7, 7, 1, 3, 1.22, '这是普通的vip');
INSERT INTO `venues_allocation` VALUES (9, 7, 1, 1, 1.20, '这是标准的豪华厅');
INSERT INTO `venues_allocation` VALUES (10, 6, 1, 3, 1.00, 'vip标准间');
...
delimiter ;;
CREATE DEFINER = `skip-grants user`@`skip-grants host` TRIGGER `addcollection` AFTER INSERT ON `user` FOR EACH ROW BEGIN
DECLARE num int;
DECLARE venue int;
DECLARE count int;
set count=0;
set num=(SELECT count(*) num from venues );
while count<num do
set venue=(SELECT venuesid from venues limit count,1);
INSERT into collections(userid,venuesid) 
VALUES(new.userid,venue);
set count=count+1;
end while;
end
;;
...
-- ----------------------------
-- Triggers structure for table venues
-- ----------------------------
DROP TRIGGER IF EXISTS `addcollections_v`;
delimiter ;;
CREATE DEFINER = `skip-grants user`@`skip-grants host` TRIGGER `addcollections_v` AFTER INSERT ON `venues` FOR EACH ROW BEGIN
DECLARE num int;
DECLARE users int;
DECLARE count int;
set count=0;
set num=(SELECT count(*) num from user );
while count<num do
set users=(SELECT userid from user limit count,1);
INSERT into collections(userid,venuesid) 
VALUES(users,new.venuesid);
set count=count+1;
end while;
end
;;

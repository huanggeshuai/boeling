...
function generateMenu(menuId, systemName) {
    if (menuId == "") {
      ...
      //  var url = "./json/menu/menu_" + menuId + ".json";
        var url = "menu/lookmenu.action?pid="+pid;
        $.get(
            url,  // 获取第一层目录
            function (data) {
                if (data == "0") {
                ...
                $.each(data, function (i, e) {// 循环创建手风琴的项
                    ...
                    $.parser.parse();
                 //   $.get("./json/menu/menu_" + e.id + ".json"
                    $.get( "menu/lookmenu.action?pid="+e.id
                        ...
                        $("#tree" + e.id).tree({
                            ...
                            onBeforeExpand: function (node, param) {
                                ...
                                $("#tree" + e.id).tree('options').url = "menu/lookmenu.action?pid="+ node.id;
                            },
